...
class PDF_Signature
{
    ...
    public function process()
    {
        ...
        || ($this->PDFtype == 'credit_note') && get_option('show_pdf_signature_credit_note') == 1) {
			...
			$note = "<small>This is a computer-generated document. No signature is required</small>";

		   $this->PDFinstance->MultiCell(($dimensions['wk'] / 2) - $dimensions['lm'], 0, $note, 0, 'J', 0, 0, '', '', true, 0, true, true, 0);
