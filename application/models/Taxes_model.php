...
class Taxes_model extends CRM_Model {
    ...
    public function delete($id) {
        if (
                is_reference_in_table('tax', 'tblitems', $id) || is_reference_in_table('tax2', 'tblitems', $id) || is_reference_in_table('tax', 'tblexpenses', $id) || is_reference_in_table('tax2', 'tblexpenses', $id) || is_reference_in_table('tax_id', 'tblsubscriptions', $id)
        ) {
            return [
                'referenced' => true,
            ];
