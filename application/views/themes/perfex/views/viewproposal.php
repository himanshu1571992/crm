      ...
      <div class="row">
        <div class="col-md-12">
         ...
         <div class="col-md-12">
            ...
            <?php } ?>
            <?php echo form_open($this->uri->uri_string()); ?>
            <button type="button" data-toggle="modal" data-target="#myModal" autocomplete="off" class="btn btn-default pull-right mleft5"><i class="fa fa-remove"></i> <?php echo _l('proposal_decline_info'); ?></button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Quotation Remark</h4>
      </div>
      <div class="modal-body">
        
         <div class="row"> 
         <div class="col-md-12"> 
            <label for="client_remark" class="control-label">Add Remark</label>
            <textarea id="client_remark" name="client_remark" required="" class="form-control"></textarea>
        </div>
        </div>
