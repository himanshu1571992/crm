            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table items">
                        ...
                        <tbody>
                           <?php
                          // $items_data = get_table_items_and_taxe($estimate->items,'estimate');
            ...
            <table class="table text-right">
                <tbody>
                    <tr id="subtotal">
                        ...
                        <td class="subtotal">
                            <?php echo format_money($subtotal,$estimate->symbol); ?>
                        </td>
                    </tr>
					...
					if($othercharges[0]['category_name']!='')
					{
						foreach ($othercharges as $othercharge)
						{
							...
							echo'<tr>
											<td><span class="bold">' . $othercharge['category_name'] . '</span></td>
											<td>' . format_money($othercharge['total_maount'], $estimate->symbol) . '</td>
										</tr>';
						}
					}
					?>
                    <tr>
                        ...
                        <td class="total">
                            <?php echo format_money($prototal,$estimate->symbol); ?>
                        </td>
                    </tr>
                </tbody>
            </table>
