         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="no-margin"><?php echo $title; ?> <a href="<?php echo admin_url('departments/add_subdivision'); ?>" type="submit" class="btn btn-info pull-right" style="margin-top:-6px;">Add Sub Division</a></h4>
