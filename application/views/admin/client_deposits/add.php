                ...
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="checkbox checkbox-danger pull-right">
                                        <input type="checkbox" id="on_account" <?php echo (!empty($client_deposits) && $client_deposits->on_account == '1') ? "checked": ""; ?> name="on_account">
                                ...
                                <div id="cheque_div" hidden>
                                    ...
                                    <div class="form-group col-md-4">     
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="cheque_no" onkeyup="nospaces(this)" name="cheque_no" class="form-control onlynumbers1" value="<?php echo (isset($client_deposits)) ? $client_deposits->cheque_no : ""; ?>">                                   
                                        </div>
                                    </div>
                                ...
                                <div class="form-group col-md-4" id="amt_div">                                   
                                    ...
                                    <input type="text" id="ttl_amt" name="ttl_amt" class="form-control" required value="<?php echo (isset($client_deposits)) ? $client_deposits->ttl_amt : ""; ?>">                                   
                                ...
                                <div class="form-group col-md-4">                                   
                                    ...
                                    <input type="text" id="reference_no" name="reference_no" class="form-control" value="<?php echo (isset($client_deposits)) ? $client_deposits->reference_no : ""; ?>">                                   
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea id="remark" name="remark" class="form-control"><?php echo (isset($client_deposits)) ? $client_deposits->remark : ""; ?></textarea>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    if (!empty($file_info)) {
                                        foreach ($file_info as $file_key) {
                                            ?>
                                            <a target="_blank" href="<?php echo base_url('uploads/client_deposits/' . $client_deposits->id . '/' . $file_key->file_name); ?>" ><b><?php echo $file_key->file_name; ?></b></a> <br>       
                                            <?php
                                        }
                                    }
                                    ?>
                                                ...
                                                <optgroup class="<?php echo 'group' . $Staffgroup_value['id'] ?>">
                                                    ...
                                                    foreach ($Staffgroup_value['staffs'] as $singstaff) {
                                                        ...
                                                        foreach ($approved_by as $approvby) {
                                                            if (isset($approvby->staff_id) && ($singstaff['staffid'] == $approvby->staff_id)) {
                                                                echo'selected';
                                                            }
                                                        }
