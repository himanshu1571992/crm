                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            ...
                            if(check_permission_page(69,'create') ){
                                ?>
                                    <a href="<?php echo admin_url('product/product'); ?>" class="btn btn-info mright5 test pull-left display-block">
...
<script>
    $(function () {
        initDataTable('.table-product', admin_url + 'product/table',<?php echo do_action('product_table_default_order', json_encode(array(8, 'DESC'))); ?>);
    });
</script>
</body>
</html>
