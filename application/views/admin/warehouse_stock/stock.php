            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <h4><?php echo (isset($stockdata['id'])) ? 'Edit Stock' : 'Add Stock'; ?></h4>
                                <hr/>
                                <div class="col-md-6">	
                                            ...
                                            <option value=""></option>
                                                ...
                                                if (isset($allStaffdata) && count($allStaffdata) > 0) {
                                                    ...
                                                    {?>
                                                        ...
                                                        {?>
                                                            <option value="<?php echo 'staff'.$singstaff['staffid'] ?>" <?php if(isset($approvby) && in_array($singstaff['staffid'],$approvby)){echo'selected';}?>><?php echo $singstaff['firstname'] ?></option>
                                                        <?php
                                                        }?>
                                                        </optgroup>
                                                    <?php
                                ...
                                <div class="table-responsive s_table compdv">
                                            ...
                                            if (isset($prostockdata) && count($prostockdata) > 0) {
                                                ...
                                                foreach ($prostockdata as $singleproductcomp) {
                                                    ...
                                                    <tr class="main" id="tr<?php echo $i; ?>">
                                                        ...
                                                        <td id="view<?php echo $i; ?>"><a href="../../product_new/view/<?php echo $singleproductcomp['product_id'];?>" target="_blank">view</a></td>
                                    ...
                                    <div class="col-xs-12">
                                        <label class="label-control subHeads"><a  class="addmore" value="<?php if(!empty($prostockdata)){ count($prostockdata); }else{ echo '0'; } ?>">Add More <i class="fa fa-plus"></i></a></label>
                                    </div>
                                </div>
                                <div class="col-md-12">	
...
?></select></div></td><td id="view'+newaddmore+'"></td><td> <div class="form-group"><input type="number" id="qty" name="componnetdata[' + newaddmore + '][qty]" class="form-control" ></div></td><td><div class="form-group"><textarea id="remarks" name="componnetdata[' + newaddmore + '][remarks]" class="form-control" ></textarea></div></td><td><button type="button" value="' + newaddmore + '" class="btn pull-right btn-danger" onclick="removeprocomp(' + newaddmore + ');"><i class="fa fa-remove"></i></button></td></tr>');
	...
	{
		var prodid = value;
        var url = "<?php echo admin_url();?>product_new/view/"+prodid;
        $('#view'+proid).html('<a href="'+url+'" target="_blank">view</a>');
		/*var html = '<option value=""></option>';
		$.ajax({
	...
	function get_comp_det(proid,value)
	{
        ...
        var url = "<?php echo admin_url();?>product_new/view/"+component_id;
        $('#view'+proid).html('<a href="'+url+'" target="_blank">view</a>');
		/*var html = '<option value=""></option>';
		$.ajax({
