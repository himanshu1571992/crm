            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <?php if(check_permission_page(159,'create') ){ ?>
                            <a href="<?php echo admin_url('Stock/transferstock'); ?>" class="btn btn-info mright5 test pull-left display-block">
                                <?php echo _l('transfer_stock'); ?>
                            </a>
                            <?php
                            }
                            ?>
...
//                            '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="warehouses"><label></label></div>',
                            ...
                            'Service Type',
                            'Transfer Type',
                            _l('transfer_stock_from_warehouse'),
                            _l('transfer_stock_to_warehouse'),
                            'Create At'
...
<script>
    $(function () {
        initDataTable('.table-warehouse', admin_url + 'Stock/tabletransferstock',<?php echo do_action('warehouse_table_default_order', json_encode(array(4, 'DESC'))); ?>);
    });
</script>
</body>
</html>
