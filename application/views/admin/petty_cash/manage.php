         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="no-margin"><?php echo $title; ?> <?php if(check_permission_page('134,266','create') ){ ?> <a href="<?php echo admin_url('petty_cash/add'); ?>" type="submit" class="btn btn-info pull-right" style="margin-top:-6px;">Add New Department</a> <?php } ?></h4>
