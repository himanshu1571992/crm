         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="no-margin">Cutting List <?php if(check_permission_page(178,'create')){ ?><a href="<?php echo admin_url('manufacture_process/cutting_process'); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">Make Cutting</a><?php } ?></h4>
                                ...
                                <table class="table ui-table">
                                    ...
                                    if(!empty($cuttitng_info)){
                                        ...
                                        foreach($cuttitng_info as $row){  
                                            ...
                                            <tr>
                                                <td><?php echo $i++;?></td>
                                                <td><?php echo 'CP-'.str_pad($row->id, 4, "0", STR_PAD_LEFT);?></td>
...
<script type="text/javascript">
    $(document).on('click', '.c_id', function()   
    {
        var id = $(this).val();        
            ...
            $.ajax({
                type    : "POST",
                url     : "<?php echo site_url('admin/manufacture_process/get_cutting_details'); ?>",
                data    : {'id' : id},
