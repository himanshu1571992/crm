                                ...
                                <select class="form-control selectpicker" data-live-search="true" id="product_id" name="product_id">
                                    ...
                                    if (isset($product_info) && count($product_info) > 0) {
                                        foreach ($product_info as $value) {
                                            ?>
                                            <option value="<?php echo $value['id'] ?>" <?php if(!empty($s_product_id) && $s_product_id == $value['id']){ echo 'selected'; } ?>><?php echo cc($value['sub_name']); ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
								...
								<table class="table ui-table">
									...
									if(!empty($stock_list)){
										...
										foreach($stock_list as $row){												
											...
											<tr>
												<td><?php echo $z++;?></td>
												<td><?php if($row->stock_type == 5){ echo 'Waste'; }else{ ?><a target="_balnk" href="<?php echo admin_url('product_new/view/'.$row->pro_id); ?>"><?php echo cc(value_by_id('tblproducts',$row->pro_id,'sub_name')); ?></a><?php }?></td>
