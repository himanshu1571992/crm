...
<div id="wrapper">
    <div class="content accounting-template">
        <div class="row">
            <form action="<?php echo admin_url('painting_department/add_request');?>" class="proposal-form" enctype="multipart/form-data" method="post" accept-charset="utf-8" >
            <div class="col-md-12">
                <div class="panel_s">
...
<script type="text/javascript">
    $(document).on('change', '#quantity', function() { 
            ...
            $.ajax({
                type    : "POST",
                url     : "<?php echo base_url(); ?>admin/painting_department/get_component_details",
