...
<div id="wrapper">
    <div class="content accounting-template">
		 <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php  echo admin_url('painting_department'); ?>">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
             
					<h4 class="no-margin"><?php echo $title; ?> <?php if(check_permission_page(197,'create')){ ?><a href="<?php echo admin_url('painting_department/add_request'); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">Add Item Request</a><?php } ?></h4>
										...
										foreach($request_list as $row){	
											...
											<tr>
												...
												<td>
													...
													if(check_permission_page(197,'delete')){ 
														if($row->approve_status == 1){
													?>
														<a class="btn btn-danger _delete" href="<?php  echo admin_url('painting_department/delete_request/'.$row->id); ?>">Delete</a>
													<?php
														}
													}
													?>	
...
$(document).on('click', '.confirm', function() {  
    ...
    $.ajax({
        type    : "POST",
        url     : "<?php echo site_url('admin/painting_department/get_confirmation_html'); ?>",
        data    : {'id' : id},
