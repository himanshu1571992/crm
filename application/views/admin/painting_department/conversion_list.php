         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="no-margin"> <?php echo $title;  if(check_permission_page(199,'create')){ ?><a href="<?php echo admin_url('painting_department/conversion'); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">Make Conversion</a><?php } ?></h4>
...
<script type="text/javascript">
    $(document).on('click', '.c_id', function()   
    {
        var id = $(this).val();        
            ...
            $.ajax({
                type    : "POST",
                url     : "<?php echo site_url('admin/painting_department/get_conversion_details'); ?>",
                data    : {'id' : id},
