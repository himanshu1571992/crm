         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="no-margin"><?php echo $title; ?> <?php if(check_permission_page(290,'create')){ ?> <a href="<?php echo admin_url('productcustom/customfield'); ?>" type="submit" class="btn btn-info pull-right" style="margin-top:-6px;">Add New Field</a> <?php } ?></h4>
                                    ...
                                    if(!empty($fields_info)){
                                        ...
                                        foreach($fields_info as $row){  
                                            ...
                                            $toggleActive = '<div class="onoffswitch">
                                                <input type="checkbox" data-switch-url="' . admin_url() . 'productcustom/change_field_status" name="onoffswitch" class="onoffswitch-checkbox" id="' . $row->id . '" data-id="' . $row->id . '" ' . $checked . '>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php 
                                                    if(check_permission_page(290,'edit')){
                                                    ?>
                                                        <a href="<?php echo admin_url('productcustom/customfield/'.$row->id); ?>" class="btn btn-info" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                        <?php
                                                    }
