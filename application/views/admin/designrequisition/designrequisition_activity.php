                            ...
                            <div class="row">
                                ...
                                <div role="tabpanel" class="tab-pane" id="lead_activity">
                                    <div class="panel_s no-shadow">
                                        ...
                                        <input type="hidden" value="<?php echo $design_requisition_id; ?>" id="design_requisition_id" name="design_requisition_id">
...
<script type="text/javascript">
    $(document).on('click', '.priority', function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/designrequisition/udpate_designrequisition_priority'); ?>",
...
<script type="text/javascript">
    $(document).on('click', '#load_more', function () {
        ...
        var id = $("#last_id").val();
        var design_requisition_id = $("#design_requisition_id").val();

        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo site_url('admin/designrequisition/get_last_designrequisition_conversion'); ?>",
            data: {'id': id, 'designrequisition_id': design_requisition_id},
            success: function (response) {
                if (response != '') {
 ...
 $(document).on("click",".view_reply", function(){
    ...
    $(this).addClass("toggle_reply");
      $.ajax({
          ...
          data    : {'id': last_reply_id, 'logid' : logid, 'section': 'designrequisition'},
          success : function(response){
            if(response != ''){
