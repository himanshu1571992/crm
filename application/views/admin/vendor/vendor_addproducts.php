          ...
          <hr class="hr-panel-heading">
                 ...
                 <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control selectpicker" data-live-search="true" id="product_id" name="product_id" required>
                            <option value="" disabled selected >--Select One-</option>
                            <?php
                            if(!empty($product_info)){
                              foreach ($product_info as $key => $value) {
                                ?>
                                  <option value="<?php echo $value->id; ?>"  ><?php echo 'PRO-'.$value->id.' - '.$value->sub_name; ?></option>
                                <?php
                              }
                            }
                            ?>
                    ...
                    <div class="form-group col-md-6">
                        <label for="product_name" class="control-label">Vendor Product Name  <small>(Same As Our Product) <input type="checkbox" id="sameAsOur"></small></label>
                 ...
                 ><label for="Remark" class="control-label">Remark</label><textarea id="remark" name="remark" class="form-control" rows="4" ></textarea>
               </div>
              </div>
              </div>                    
...
<script type="text/javascript">
  $('#sameAsOur').click(function(){
	  if($('#sameAsOur').is(':checked')){
		   var selectedProductName = $("#product_id").children("option:selected").text();
