...
<div class="content">
   ...
   <div class="row">
      ...
      <div class="col-md-2">
         ...
         <?php echo master_report_tab('purchaseinvoice');?>
            ...
            <div class="col-md-10">
                ...
                <div class="panel_s">
                   ...
                   <h4 class="no-margin"><?php echo $title; ?> <!-- <a href="<?php echo admin_url('master_report_export/export_purchaseinvoice?range='.$s_range.'&f_date='.$date_a.'&t_date='.$date_b.'&staff_id='.$staff); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">Export</a> --></h4>
                  ...
                  if(!empty($invoice_list)){
                      ...
                      foreach ($invoice_list as $key => $value) {
                          ...
                          <tr>
                              ...
                              <td><a href="<?php echo admin_url('purchase/purchase_invoice_pdf/'.$value->id);?>" target="_blank"><?php echo 'Inv-'.str_pad($value->id, 4, '0', STR_PAD_LEFT); ?></a></td>
