...
<div class="content">
   ...
   <div class="row">
      ...
      <div class="col-md-2">
         ...
         <?php echo master_report_tab('invoice');?>
            ...
            <div class="col-md-10">
                ...
                <div class="panel_s">
                   ...
                   <h4 class="no-margin"><?php echo $title; ?> <!-- <a href="<?php echo admin_url('master_report_export/export_invoice?range='.$s_range.'&f_date='.$date_a.'&t_date='.$date_b.'&staff_id='.$staff); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">Export</a> --></h4>
