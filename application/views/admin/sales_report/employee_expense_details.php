                                ...
                                <div class="col-md-12">
                                    <fieldset class="scheduler-border"><br>
                                        <div class="col-md-12" align="center">
                                            <span style="font-size:20px;">Employee Name : </span><span style="color: red;font-size:20px;"><?php echo get_employee_name($employee_id); ?></span>
                                        </div>
                                        <div class="col-md-12" align="center">
                                        ...
                                        <div class="col-md-12" align="center">
                                            <span style="font-size:20px;">Sub Type : </span><span style="color: red;font-size:20px;" ><?php echo value_by_id('tblexpensetypesub', $subtypeid, 'name'); ?></span>
                                        </div>
                                    </fieldset>
                                    <hr>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="newtable">
                                            ...
                                            <tbody>
                                                <?php
                                                    $ttlamount = 0;
                                                    if (!empty($employee_expense_list)){
                                                        foreach ($employee_expense_list as $k => $value) {
                                                            $parent_id = ($value->parent_id > 0) ? $value->parent_id : $value->id;
                                                            $remark = (!empty($value->note)) ? $value->note : '--';
                                                            $expenseno = 'EXP-' . get_short(get_expense_category($value->category)) . '-' . number_series($parent_id);
                                                            $ttlamount += $value->amount;
                                                            echo '<tr>
                                                                    <td align="center">'.++$k.'</td>
                                                                    <td align="center">'.$expenseno.'</td>
                                                                    <td align="center">'._d($value->date).'</td>
