         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <?php if(check_permission_page(363,'create')){?>
                    <a href="<?php echo admin_url('stock_consumption/stock_issue_add'); ?>" class="btn btn-info pull-right" style="margin-top:-6px; "> Add Stock Issue </a>
                    <?php } ?>
                    </h4>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-info" href="<?php echo admin_url('stock_consumption/stock_issue_view/' . $value->id); ?>" title="View" ><i class="fa fa-eye"></i></a>
                                                <?php if(check_permission_page(363,'delete')){?>
                                                <a class="btn btn-danger _delete" href="<?php echo admin_url('stock_consumption/stock_issue_delete/' . $value->id); ?>" title="Delete" ><i class="fa fa-trash"></i></a>
                                                <?php } ?>
                                            </td>
                                          </tr>
                                        <?php
