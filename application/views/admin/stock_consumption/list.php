         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <?php if(check_permission_page(328,'create')){?>
                    <a href="<?php echo admin_url('stock_consumption/add'); ?>" class="btn btn-info pull-right" style="margin-top:-6px; "> Add Stock Consumption </a>
                    <?php } ?>
                    </h4>
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" id="stock_type" name="stock_type">
                                        <option value=""></option>
                                        <option value="1" <?php echo (isset($stock_type) && !empty($stock_type)) ? ($stock_type == 1) ? "selected": "" : ""; ?>>Production</option>
                                        <option value="2" <?php echo (isset($stock_type) && !empty($stock_type)) ? ($stock_type == 2) ? "selected": "" : ""; ?>>Outsource</option>
                                    </select> 
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" data-live-search="true" id="service_type" name="service_type">   
                                            ...
                                            <option value="2" <?php echo (isset($service_type) && !empty($service_type)) ? ($service_type == 2) ? "selected": "" : ""; ?>>Sales</option>                                       
                                        </select>
                                    </div>
                                </div>
                            </div>    
                            ...
                            <div class="col-md-12"> 
                                ...
                                <table class="table" id="newtable">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo ++$key; ?></td>                                                
                                            <td><?php echo ($value->type == 1) ? "Production": "Outsource"; ?></td>
                                            ...
                                            <td><a href="javascript:void(0)" class="status" data-id="<?php echo $value->id; ?>" onclick="get_assign_status(<?php echo $value->id; ?>);" data-target="#stock_status" id="status" data-toggle="modal"><?php echo array_search($value->status, $status_arr) ?></a></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right toggle-menu">
                                                        <li>
                                                            <a href="<?php echo admin_url('stock_consumption/view/' . $value->id); ?>" title="View" >View</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
