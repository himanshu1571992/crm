    ...
    <div class="content accounting-template">
        <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data"
                action="<?php  echo admin_url('purchase/pending_mr'); ?>">
                <div class="col-md-12">
                    <div class="panel_s">
                        <div class="panel-body">
                            ...
                            <div class="row panelHead">
                                ...
                                <div class="col-xs-12 col-md-6 text-right">
                                    <?php if(check_permission_page(43,'create')){ ?><a
                                        href="<?php  echo admin_url('purchase/purchase_order'); ?>"
                                        class="btn btn-info">Add Purchase Order</a><?php } ?></div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" name="type">
                                        <option value=""></option>
                                        <option value="1"
                                            <?php echo (!empty($s_type) && $s_type == 1) ? 'selected' : ''; ?>>Against
                                            PO</option>
                                        <option value="2"
                                            <?php echo (!empty($s_type) && $s_type == 2) ? 'selected' : ''; ?>>Cash
                                        </option>
                                        <option value="3"
                                            <?php echo (!empty($s_type) && $s_type == 3) ? 'selected' : ''; ?>>Gas
                                        </option>
                                        <option value="4"
                                            <?php echo (!empty($s_type) && $s_type == 4) ? 'selected' : ''; ?>>Delivery
                                            Challan</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-3" app-field-wrapper="date">
                                    ...
                                    <div class="input-group date">
                                        <input id="f_date" name="f_date" class="form-control datepicker"
                                            value="<?php echo (isset($s_fdate) && $s_fdate != "") ? $s_fdate : ''; ?>"
                                ...
                                <div class="form-group col-md-3" app-field-wrapper="date">
                                    ...
                                    <div class="input-group date">
                                        <input id="t_date" name="t_date" class="form-control datepicker"
                                            value="<?php echo (isset($s_tdate) && $s_tdate != "") ? $s_tdate : ''; ?>"
                                            aria-invalid="false" type="text">
                                        <div class="input-group-addon"><i class="fa fa-calendar calendar-icon"></i>
                                        </div>
                                    </div>
											...
											?>
													<tr>
														...
														<td class="text-center">
															<a class="tableBtn" target="_blank"
																href="<?php  echo admin_url('purchase/mr_approval/'.$row->id); ?>"><i
