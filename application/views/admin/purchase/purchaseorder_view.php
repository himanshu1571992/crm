...
<style>.error{border:1px solid red !important;}#adminnote{margin: 0px 8.5px 0px 0px;width:100%;height: 100px;}.red{border:1px solid red !important;background-color:red !important;color:#fff !important;}.yellow{border:1px solid yellow !important;background-color:yellow !important;color:black  !important;}.blue{border:1px solid blue !important;background-color:blue !important;color:#fff !important;}.green{border:1px solid green !important;background-color:green !important;color:#fff !important;}.orange{border:1px solid orange !important;background-color:orange !important;color:#fff !important;}</style>
...
<?php
$can_edit = $this->db->query("SELECT * from tblpurchaseorderapproval where po_id = '".$purchase_info['id']."' and (approve_status = 1 || approve_status = 2) ")->row_array();
?>
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-1">
                                ...
                                if((check_permission_page(40,'delete')) && (empty($can_edit))){
                                    ?>
                                    <a style="color: #fff;" class="btn btn-danger _delete" href="<?php echo admin_url('purchase/deletepo/'.$purchase_info['id']);?>" data-status="1">DELETE</a>
                                    <?php
                                }
                                ?>
                            ...
                            <div class="col-md-1">
                                <a style="color: #fff;" class="btn btn-danger text-danger _delete" href="<?php echo admin_url('purchase/cancelpo/'.$purchase_info['id']);?>" data-status="1">CANCEL</a>
                            </div> -->
                            ...
                            <div class="col-md-6">
                                <div class="panel_s no-shadow">
                                    ...
                                    <div class="form-group" app-field-wrapper="adminnote">
                                        ...
                                        <textarea id="adminnote" name="adminnote" class="form-control" disabled="" rows="4"><?php echo $value; ?></textarea>

                                    </div>
                                    <div class="form-group transportation_charges_div" <?php echo (!empty($purchase_info) && $purchase_info['transportation_charges'] != '0.00') ? "": 'style="display:none;"';?>>
                                        <label for="transportation_charges" class="control-label">Transportation Charges Amount</label>
                                        <input type="text" readonly name="transportation_charges" class="form-control" value="<?php echo (!empty($purchase_info) && $purchase_info['transportation_charges'] != '0.00') ? $purchase_info["transportation_charges"] : "";?>">
                                    </div>
                                    <?php 
                                        ...
                                        <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop saletable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td style="width: 85px !important;"><?php echo _l('prop_pro_hsn_code'); ?></td>
                                                    <td style="width: 75px !important;">Remark</td>
                                                    <td style="width: 35px !important;">Unit</td>
                                                    <td style="width: 75px  !important;"><?php echo _l('prop_pro_qty'); ?></td>
                                                    <td style="width: 75px !important;"><?php echo _l('prop_pro_price'); ?></td>
                                                    <td style="width: 75px !important;"><?php echo _l('prop_pro_tot_price'); ?></td>
                                                    <td style="width: 70px !important;"><?php echo _l('prop_pro_disc'); ?>%</td>
                                                    <td style="width: 70px !important;"><?php echo _l('prop_pro_disc_amt'); ?></td>
                                                    <td style="width: 90px !important;"><?php echo _l('prop_pro_disc_price'); ?></td>
                                ...
                                <div class="table-responsive s_table" style="margin-top:3%;">
                                  ...
                                  <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop saletable">
                                      ...
                                      <tbody class="ui-sortable">
                                          <td><textarea class="form-control" disabled name="roundoff_remark"><?php echo (isset($purchase_info) && $purchase_info['roundoff_remark'] != '') ? $purchase_info['roundoff_remark'] : ""; ?></textarea></td>
                                          <td><input type="number" readonly class="form-control roundoffamount" name="roundoff_amount" value="<?php echo (isset($purchase_info['roundoff_amount'])) ? $purchase_info['roundoff_amount'] : ""; ?>"></td>
                                      </tbody>
                                  </table>
                                </div>
                            </div>
