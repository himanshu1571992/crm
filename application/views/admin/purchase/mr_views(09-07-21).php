                ...
                <div class="panel_s">
                    ...
                    <div class="row panelHead">
                        <div class="col-xs-12 col-md-6">
                            <h4><?php echo $title;  if(check_permission_page(43,'create')){ ?></h4>
                        </div>
					...
					<div class="row">
						...
						<div class="form-group col-md-2">
                            ...
                            <select class="form-control selectpicker" data-live-search="true" name="type">
                                <option value=""></option>
                                <option value="1" <?php if(!empty($s_type) && $s_type == 1){ echo 'selected'; } ?>>Against PO</option>
                                <option value="2" <?php if(!empty($s_type) && $s_type == 2){ echo 'selected'; } ?>>Cash</option>
                                <option value="3" <?php if(!empty($s_type) && $s_type == 3){ echo 'selected'; } ?>>Gas</option>
                            </select>
                        </div>
									...
									if(!empty($materialreceipt_list)){
										...
										foreach($materialreceipt_list as $row){	
											...
											<tr>
												...
												<td>
													<a class="tableBtn" title="View" target="_blank" href="<?php  echo admin_url('purchase/mr_details/'.$row->id); ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                    ...
                                                    <a style="color: red;" class="text-danger _delete" href="<?php echo admin_url('purchase/deletemr/'.$row->id);?>" data-status="1">DELETE</a> 
												</td>
