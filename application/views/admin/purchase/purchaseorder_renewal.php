                               ...
                               $yyyy = date('Y');
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="vendor_contact_number" name="vendor_contact_number" required="" minlength="10" maxlength="10" class="form-control" value="<?php echo (isset($purchase_info) ? $purchase_info['vendor_contact_number'] : '');?>" >
                                    </div>
                                    <div class="form-group col-md-6">
...
if (check_gst == 0)
{
    ...
    if (isset($product_data) && count($product_data) > 0) {
        foreach ($product_data as $product_key => $product_value) {
            ...
            ?><option data-is_temp="<?php echo $product_value['is_temp']; ?>" value="<?php echo $product_value['id'] ?>"><?php echo $product_value['sub_name'].$product_code ?></option><?php
        }
    }
