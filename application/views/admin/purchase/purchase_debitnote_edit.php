                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker vendor_id" disabled="" data-live-search="true" required="" id="vendor_id" name="vendor_id">
                                        ...
                                        if (isset($vendors_info) && count($vendors_info) > 0) {
                                            ...
                                            foreach ($vendors_info as $vendor_value) {
                                                ...
                                                <option value="<?php echo $vendor_value['id'] ?>" <?php echo (!empty($debitnoteinfo) && $debitnoteinfo->vender_id == $vendor_value['id']) ? 'selected' : "" ?>><?php echo $vendor_value['name'] ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                        $po_number = "";
                                        if (!empty($debitnoteinfo) && $debitnoteinfo->po_id > 0){
                                            
                                            $ponumber = value_by_id_empty("tblpurchaseorder", $debitnoteinfo->po_id, "number");
                                ...
                                <?php if (!empty($debitnoteinfo) && $debitnoteinfo->is_direct == 0){ ?>
                                    <div class="form-group" app-field-wrapper="challan_no">

                                        <label for="challan_no" class="control-label">Challan No.</label>

                                        <input type="text" id="challan_no" name="challan_no" class="form-control" readonly="" value="<?php echo (!empty($debitnoteinfo) && !empty($debitnoteinfo->challan_number)) ? $debitnoteinfo->challan_number : ""; ?>">
                                ...
                                <?php }else{ ?>
                                    <div class="form-group" app-field-wrapper="credit_note_no">
                                        ...
                                        <input type="text" id="credit_note_no" name="credit_note_no" class="form-control" value="<?php echo (!empty($debitnoteinfo) && !empty($debitnoteinfo->credit_note_no)) ? $debitnoteinfo->credit_note_no : ""; ?>">
                            ...
                            <?php
                                    $mr_details = $this->db->query("SELECT * FROM `tblmaterialreceipt` where `id`='" . $debitnoteinfo->mr_id . "' ")->row();
                                ?>
                            <div class="col-md-6">
                                <div class="panel_s no-shadow">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php
                                                $pdn_date = (!empty($debitnoteinfo->date)) ? _d($debitnoteinfo->date) : _d(date('Y-m-d'));
                                            ?>
                                            <?php echo render_date_input('date', 'Date', $pdn_date); ?>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select required="" class="form-control selectpicker" required="" name="tax_type" data-live-search="true">
                                                    <option value=""></option>
                                                    <option value="1" <?php echo (!empty($debitnoteinfo) && $debitnoteinfo->tax_type == 1) ? "selected": ""; ?>>CGST+SGST</option>
                                                    <option value="2" <?php echo (!empty($debitnoteinfo) && $debitnoteinfo->tax_type == 2) ? "selected": ""; ?>>IGST</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div id="product_div">
                                    <div style="overflow-x:auto !important;">
                                        <div class="form-group" id="docAttachDivVideo" style="margin-left:10px;width:1800px !important;">
                                            <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop saletable">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $productinfo = $this->db->query("SELECT * FROM tblpurchasedabitnoteproducts WHERE purchasedebitnote_id = '".$debitnoteinfo->id."'")->result_array();
                                                        $i = 1;
                                                        $totsaleprod = 0;
                                                        ...
                                                        <?php
                                                            ...
                                                            if ($single_prod_sale_det["is_temp"] == 0){
                                                                ...
                                                                $ttl_price = $single_prod_sale_det['qty'] * $single_prod_sale_det['price'];
                                                                $tax_amt = (($ttl_price * $single_prod_sale_det['prodtax']) /100);
                                    ...
                                    <div class="row" style="margin-top:2%;">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input readonly="" type="text" class="form-control sale_total_amt" value="<?php echo (!empty($debitnoteinfo) && !empty($debitnoteinfo->finalsubtotalamount)) ? $debitnoteinfo->finalsubtotalamount : $tt_amt; ?>" name="saleproposal[finalsubtotalamount]" id="sale_total_amt">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" class="form-control sale_discount_percentage onlynumbers" value="<?php echo (!empty($debitnoteinfo) && !empty($debitnoteinfo->finaldiscountpercentage)) ? $debitnoteinfo->finaldiscountpercentage : 0; ?>" onchange="get_total_disc_sale()" name="saleproposal[finaldiscountpercentage]" id="sale_discount_percentage">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input readonly="" type="text" class="form-control sale_discount_amt" value="<?php echo (!empty($debitnoteinfo) && !empty($debitnoteinfo->finaldiscountamount)) ? $debitnoteinfo->finaldiscountamount : "0.00"; ?>" name="saleproposal[finaldiscountamount]" id="sale_discount_amt">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input style="font-weight:bold;" readonly="" type="text" class="form-control sale_total_quotation_amt" value="<?php echo (!empty($debitnoteinfo) && !empty($debitnoteinfo->totalamount)) ? $debitnoteinfo->totalamount : $tt_amt; ?>" name="saleproposal[totalamount]" id="sale_total_quotation_amt">
                                ...
                                <div  class="col-md-12" style="margin-top: 15px;">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control tinymce" name="note" id="note"><?php echo (!empty($debitnoteinfo->note)) ? $debitnoteinfo->note : ""; ?></textarea>
                                    </div>
                                </div>
                                <div  class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control tinymce" name="terms_and_conditions" id="terms_and_conditions">
                                            <?php echo (!empty($debitnoteinfo->terms_and_conditions)) ? $debitnoteinfo->terms_and_conditions : get_terms_conditions('purchase_debit_note'); ?>
                                        </textarea>
                                    </div>
                                </div>
                            </div>
