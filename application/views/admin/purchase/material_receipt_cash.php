                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <?php
                                            ...
                                            }elseif(isset($purchase_info) && !empty($purchase_info['service_type'])){
                                                $service_type = $purchase_info['service_type'];
                                            }
                                        ?>
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        $tax_type = "";
                                        if (isset($materialreceipt_info) && !empty($materialreceipt_info)){
                                            $tax_type = $materialreceipt_info->tax_type;
                                        }elseif(isset($purchase_info) && !empty($purchase_info['tax_type'])){
                                            $tax_type = $purchase_info['tax_type'];
                                        }
                                    ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" data-live-search="true" required="" id="tax_type" name="tax_type">
                                                <option value="2" <?php echo ($tax_type == 2) ? 'selected' : ''; ?>>Excluding</option>
                                                <option value="1" <?php echo ($tax_type == 1) ? 'selected' : ''; ?> >Including</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2" app-field-wrapper="extrusion">
                                        ...
                                        <?php
                                            $extrusion = (isset($materialreceipt_info) && ($materialreceipt_info->extrusion == 1)) ? "checked" : "";
                                        ?>
                                        <input type="checkbox" name="extrusion" value="1" <?php echo $extrusion; ?>>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div style="overflow-x:auto !important;">
                                    ...
                                    <div class="form-group" id="docAttachDivVideo" style="margin-left:10px;width:1800px !important;">
                                        ...
                                        <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop saletable">
                                            ...
                                            <tbody>
                                            ...
                                            } elseif (isset($mr_product_list)) {

                                                $totsaleprod = count($mr_product_list);
                                                ?>

                                                <input type="hidden" id="totalsalepro" value="<?php echo count($mr_product_list); ?>">

                                                <?php
                                                foreach ($mr_product_list as $single_prod_sale_det) {
                                                    ...
                                                    <tr class="trsalepro<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a target="_blank" href="<?php echo admin_url('product/product/').$single_prod_sale_det['product_id'];?>">

                                                                <input class="form-control" type="text" readonly="" name="saleproposal[<?php echo $i; ?>][product_name]" style="cursor: pointer !important;" value="<?php echo value_by_id("tblproducts", $single_prod_sale_det['product_id'], "sub_name"); ?>">
                                                ...
                                                if (isset($product_data) && count($product_data) > 0) {
                                                    ...
                                                    foreach ($product_data as $product_key => $product_value) {
                                                        ?><option value="<?php echo $product_value['id'] ?>"><?php echo $product_value['sub_name'] . product_code($product_value['id']) ?></option><?php
                                                    }
                                                }
                                ...
                                <div class="row" style="margin-top:2%;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <label class="control-label">Total Amount <span style="color:red">*</span></label>
                                            <?php
                                            $finalsubtotalamount = 0.00;
                                            if (isset($purchase_info) && $purchase_info['finalsubtotalamount'] != '') {
                                                $finalsubtotalamount = $purchase_info['finalsubtotalamount'];
                                            } elseif (isset($materialreceipt_info) && $materialreceipt_info->finalsubtotalamount) {
                                                $finalsubtotalamount = $materialreceipt_info->finalsubtotalamount;
                                            }
                                            ?>
                                        <input readonly="" type="text" class="form-control sale_total_amt" value="<?php echo $finalsubtotalamount; ?>" name="saleproposal[finalsubtotalamount]" id="sale_total_amt">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <?php
                                        $finaldiscountpercentage = 0.00;
                                        if (isset($purchase_info) && $purchase_info['finaldiscountpercentage'] != '') {
                                            $finaldiscountpercentage = $purchase_info['finaldiscountpercentage'];
                                        } elseif (isset($materialreceipt_info) && $materialreceipt_info->finaldiscountpercentage) {
                                            $finaldiscountpercentage = $materialreceipt_info->finaldiscountpercentage;
                                        }
                                        ?>
                                        <input type="number" class="form-control sale_discount_percentage onlynumbers" value="<?php echo $finaldiscountpercentage; ?>" onchange="get_total_disc_sale()" name="saleproposal[finaldiscountpercentage]" id="sale_discount_percentage">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        if (isset($purchase_info) && $purchase_info['finaldiscountamount'] != '') {
                                            $finaldiscountamount = $purchase_info['finaldiscountamount'];
                                        } elseif (isset($materialreceipt_info) && $materialreceipt_info->finaldiscountamount) {
                                            $finaldiscountamount = $materialreceipt_info->finaldiscountamount;
                                        }
                                        ?>
                                        <input readonly="" type="text" class="form-control sale_discount_amt" value="<?php echo $finaldiscountamount; ?>" name="saleproposal[finaldiscountamount]" id="sale_discount_amt">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Total Amount <span style="color:red">*</span></label>
                                        <?php
                                        $totalamount = 0.00;
                                        if (isset($purchase_info) && $purchase_info['totalamount'] != '') {
                                            $totalamount = $purchase_info['totalamount'];
                                        } elseif (isset($materialreceipt_info) && $materialreceipt_info->totalamount) {
                                            $totalamount = $materialreceipt_info->totalamount;
                                        }
                                        ?>
                                        <input style="font-weight:bold;" readonly="" type="text" class="form-control sale_total_quotation_amt" value="<?php echo $totalamount; ?>" name="saleproposal[totalamount]" id="sale_total_quotation_amt">
                                    </div>
                                </div>
...
if (isset($product_data) && count($product_data) > 0) {
    ...
    foreach ($product_data as $product_key => $product_value) {
        ...
        ?><option value="<?php echo $product_value['id'] ?>"><?php echo $product_value['sub_name'] ?></option><?php
