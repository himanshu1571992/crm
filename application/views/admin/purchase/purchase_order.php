                                        ...
                                        if (isset($vendors_info) && count($vendors_info) > 0) {
                                            ...
                                            foreach ($vendors_info as $vendor_value) {
                                                    if (isset($_GET['req_vendor_id'])){
                                                        $vendor_id = value_by_id('tblrequirement_productvendors', $_GET['req_vendor_id'], 'vendor_id');
                                                        $selectedcls = ($vendor_id == $vendor_value['id']) ? 'selected' : "";
                                                    }else{
                               ...
                               $yyyy = date('Y');
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="vendor_contact_number" name="vendor_contact_number" minlength="10" maxlength="10" required="" class="form-control" value="<?php echo (isset($purchase_info) ? $purchase_info['vendor_contact_number'] : '');?>" >
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="billing_contact_number" name="billing_contact_number" minlength="10" maxlength="10" required="" class="form-control" value="<?php echo (isset($purchase_info) ? $purchase_info['billing_contact_number'] : '');?>" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="number" <?php echo (!isset($purchase_info) && empty($purchase_info['number'])) ? 'readonly=""' : ''; ?> class="form-control" value="<?php echo (isset($purchase_info)) ? $purchase_info['number'] : po_next_number(); ?>" >
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div style="overflow-x:auto !important;">
                                    <div class="form-group" id="docAttachDivVideo" style="margin-left:10px;width:2500px !important;">
                                        <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop saletable">
                                            ...
                                            }else if (isset($_GET['req_vendor_id']) && isset($_GET['req_id'])){
                                                $vendorid = value_by_id('tblrequirement_productvendors', $_GET['req_vendor_id'], 'vendor_id');
                                                $req_id = $_GET['req_id'];
                                                $product_list = $this->db->query("SELECT p.*,pv.rate FROM tblrequirement_products as p LEFT JOIN tblrequirement_productvendors as pv ON pv.reqpro_id = p.id WHERE pv.vendor_id = '".$vendorid."' and pv.req_id = '".$req_id."'")->result();
                                                if (!empty($product_list)){
                                                    $totsaleprod = count($product_list);
                                            ?>
                                                     <input type="hidden" id="totalsalepro" value="<?php echo count($product_list); ?>">
                                            <?php
                                                    foreach ($product_list as $single_prod_sale_det) {
                                                       
                                                       $totproamt = ($single_prod_sale_det->rate * $single_prod_sale_det->quantity);
                                                       $taxamt = ($totproamt * 18)/100; 
                                                       $total_qty += $single_prod_sale_det->quantity;
                                                       $finalamount += ($totproamt+$taxamt);
                                            ?>
                                                        <tr class="trsalepro<?php echo $i; ?>">
                                                            <td>
                                                                <button type="button" class="btn pull-right btn-danger" onclick="removesalepro('<?php echo $i; ?>');"><i class="fa fa-remove"></i></button>
                                                            ...
                                                            <td>
                                                                <?php
                                                                        $url = admin_url("product_new/view/".$single_prod_sale_det->product_id);
                                                                        $unit_id = ($single_prod_sale_det->unit > 0) ? $single_prod_sale_det->unit : value_by_id_empty('tblproducts', $single_prod_sale_det->product_id, 'unit_2');
                                                                ?>
                                                                ...
                                                                <!-- <input value="" name="saleproposal[<?php echo $i; ?>][itemid]" type="hidden"> -->
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="number" class="form-control" id="saleqty_<?php echo $i; ?>" name="saleproposal[<?php echo $i; ?>][qty]" onchange="get_total_price_per_qty_sale(<?php echo $i; ?>)" min="1" value="<?php echo $single_prod_sale_det->quantity; ?>">
                                                            </td>
                                                            <td>
                                                                <input type="number" class="form-control" id="salemainprice_<?php echo $i; ?>" onchange="get_total_price_per_qty_sale(<?php echo $i; ?>)" value="<?php echo $single_prod_sale_det->rate; ?>" name="saleproposal[<?php echo $i; ?>][price]" id="price1">
                                                            </td>
                                                            <td>
                                                                <input readonly="" type="text" class="form-control" id="saleprice_<?php echo $i; ?>" name="saleproposal[<?php echo $i; ?>][ttl_price]" value="<?php echo $totproamt; ?>" id="total_price1">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="hidden" name="saleproposal[<?php echo $i; ?>][isgst]" value="0">
                                                                <input readonly="" type="text" class="form-control" name="saleproposal[<?php echo $i; ?>][prodtax]" id="saleprod_tax_<?php echo $i; ?>" value="<?php echo '18.00'; ?>">
                                                            </td>
                                                            <td>
                                                                <input readonly="" type="text" class="form-control" id="saletax_amt_<?php echo $i; ?>" name="saleproposal[<?php echo $i; ?>][tax_amt]" value="<?php echo $taxamt; ?>" id="total_price1">
                                                            </td>
                                                            <td class="" style="font-size: 17px;text-align: center;padding: 10px;">
                                                                <input readonly="" type="text" class="form-control grandtotal totalsaleamt" id="grand_total_sale<?php echo $i; ?>" value="<?php echo round($totproamt+$taxamt, 0); ?>">
                                                            </td>
                                                        </tr>
                                            <?php
                                                       $i++;
                                ...
                                <div class="row" style="margin-top:2%;padding:8px;">
                                    ...
                                    <div class="col-md-12 pull-right">
                                        ...
                                        <label style="font-weight:500;font-size: 16px;text-transform: capitalize;" class="col-md-6 pull-left control-label sale_total_quotation_amt_in_words text-right"><?php echo ($finalamount > 0) ? convert_number_to_words($finalamount) : ""; ?></label>
