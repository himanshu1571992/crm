...
<div id="wrapper">
    <div class="content accounting-template">
		 <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php  echo admin_url('assembling_department_second/demand'); ?>">
            <div class="col-md-12">
                <div class="panel_s">
...
$(document).on('click', '.action', function() {  
    ...
    $.ajax({
        type    : "POST",
        url     : "<?php echo site_url('admin/assembling_department_second/get_details'); ?>",
        data    : {'id' : id},
