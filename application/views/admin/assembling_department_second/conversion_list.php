         ...
         <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="no-margin"> <?php echo $title;  if(check_permission_page(209,'create')){ ?><a href="<?php echo admin_url('assembling_department_second/conversion'); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">Make Conversion</a><?php } ?></h4>
...
<script type="text/javascript">
    $(document).on('click', '.c_id', function()   
    {
        var id = $(this).val();        
            ...
            $.ajax({
                type    : "POST",
                url     : "<?php echo site_url('admin/assembling_department_second/get_conversion_details'); ?>",
                data    : {'id' : id},
