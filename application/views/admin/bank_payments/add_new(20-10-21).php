            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                                        ...
                                        <div id="cat_data_<?php echo $i;?>">
                                            <div class="row">
                                                ...
                                                <label class="control-label">Select Bank </label>                                    
                                                  <select class="form-control selectpicker" data-live-search="true" id="bank_id<?php echo $i; ?>" name="paymentdata[<?php echo $i; ?>][bank_id]">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <label class="control-label">Payment Method </label>                                    
                                                      <select required="" class="form-control selectpicker" data-live-search="true" id="method<?php echo $i; ?>" name="paymentdata[<?php echo $i; ?>][method]">
								...
								<fieldset class="scheduler-border">
										 ...
										 <div class="col-md-4">
											<select class="form-control selectpicker category" val="<?php echo $j;?>" required="" id="category_id<?php echo $j;?>" name="paymentdata[<?php echo $j;?>][category_id]">
											  ...
											  if(!empty($category_info)){
												foreach ($category_info as $value) {
													?>
													<option value="<?php echo $value->id; ?>" <?php if($value->id == 2){ echo 'selected'; } ?>><?php echo cc($value->name); ?></option>
													<?php
												}
											  }
											  ?>
									...
									<div id="cat_data_<?php echo $j;?>">
										<div class="row">
												...
												<label class="control-label">Payee Name </label>                                    
												 <select onchange="get_vendor_detl(<?php echo $j; ?>,this.value)" class="form-control selectpicker" id="payee<?php echo $j; ?>" required="" name="paymentdata[<?php echo $j; ?>][payee]">
												  ...
												  if(!empty($payee_info)){
													foreach ($payee_info as $value) {
														?>
														<option value="<?php echo $value->id; ?>" <?php if($vendor_id == $value->id){ echo 'selected'; } ?>><?php echo cc($value->name); ?></option>
														<?php
													}
												  }
												  ?>
                                            ...
                                            <div class="form-group col-md-2">
                                                <label class="control-label">Select Bank </label>                                    
                                                  <select class="form-control selectpicker" data-live-search="true" id="bank_id<?php echo $j; ?>" name="paymentdata[<?php echo $j; ?>][bank_id]">
                                                    <option value="">-- Select Bank --</option>
                                                    <?php
                                                    if(!empty($bank_info)){
                                                        foreach ($bank_info as  $bank) {
										...
										<div class="row">
											...
											<div class="form-group col-md-2">
												<label class="control-label">Payment Method </label>                                    
												  <select required="" class="form-control selectpicker" data-live-search="true" id="method<?php echo $j; ?>" name="paymentdata[<?php echo $j; ?>][method]">
										 ...
										 <div class="col-md-4">
											<select class="form-control selectpicker category" val="<?php echo $j;?>" required="" id="category_id<?php echo $j;?>" name="paymentdata[<?php echo $j;?>][category_id]">
											  ...
											  if(!empty($category_info)){
												foreach ($category_info as $value) {
													?>
													<option value="<?php echo $value->id; ?>" <?php if($value->id == 1){ echo 'selected'; } ?>><?php echo cc($value->name); ?></option>
													<?php
												}
											  }
											  ?>
												...
												<label class="control-label">Payee Name </label>                                    
												 <select onchange="get_vendor_detl(<?php echo $j; ?>,this.value)" class="form-control selectpicker" id="payee<?php echo $j; ?>" required="" name="paymentdata[<?php echo $j; ?>][payee]">
												  ...
												  if(!empty($payee_info)){
													foreach ($payee_info as $value) {
														?>
														<option value="<?php echo $value->id; ?>" <?php if($staff_id == $value->id){ echo 'selected'; } ?>><?php echo cc($value->name); ?></option>
														<?php
													}
												  }
												  ?>
										 ...
										 <div class="col-md-4">
											<select class="form-control selectpicker category" val="<?php echo $j;?>" required="" id="category_id<?php echo $j;?>" name="paymentdata[<?php echo $j;?>][category_id]">
											  ...
											  if(!empty($category_info)){
												foreach ($category_info as $value) {
													?>
													<option value="<?php echo $value->id; ?>" <?php if($value->id == 7){ echo 'selected'; } ?>><?php echo cc($value->name); ?></option>
													<?php
												}
											  }
											  ?>
												...
												<label class="control-label">Payee Name </label>                                    
												 <select onchange="get_vendor_detl(<?php echo $j; ?>,this.value)" class="form-control selectpicker" id="payee<?php echo $j; ?>" required="" name="paymentdata[<?php echo $j; ?>][payee]">
												  ...
												  if(!empty($payee_info)){
													foreach ($payee_info as $value) {
														?>
														<option value="<?php echo $value->id; ?>" <?php if($client_id == $value->id){ echo 'selected'; } ?>><?php echo cc($value->name); ?></option>
														<?php
													}
												  }
												  ?>
                        ...
                        if(!empty($save_info)){
                            echo '<input type="hidden" value="'.$save_info->id.'" name="save_id">';    
                        }
                        ?>
