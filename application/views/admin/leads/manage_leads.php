         ...
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  <div class="_buttons">
                     <?php
                     if(check_permission_page(96,'create')){
                     ?>
                     <a href="<?php echo base_url();?>/admin/leads/leads" class="btn mright5 btn-info pull-left display-block">
                        ...
                        <div class="col-md-12">
                           ...
                           <?php
                              ...
                              if(is_gdpr() && get_option('gdpr_enable_consent_for_leads') == '1') {
                               ...
                               $_table_data[] =   array(
                               'name'=>'Customer Name',
                               'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-clienname')
                              );

                              $_table_data[] =   array(
                               'name'=>'Quotation',
                               'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-quotation')
                              );
