                            ...
                            <fieldset class="scheduler-border"><br>
                                <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <p class="ttlleadamt_count" style="color: red; text-align: center;">please wait...</p>
                                        </div>
                                </div>
                            </fieldset>
                        </div> -->    
                                             ...
                                             <ul class="dropdown-menu dropdown-menu-right toggle-menu">
                                                <li>
                                                   <?php if(check_permission_page(3,'edit')){ ?>
                                                    ...
                                                    <?php } ?>
                                                    <a href="<?php echo admin_url('follow_up/special_lead_activity/'.$value->id); ?>" target="_blank"> Special Activity</a>
