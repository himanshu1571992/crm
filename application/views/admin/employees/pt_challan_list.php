                    ...
                    <div class="panel-body">
                        <div class="row panelHead">
                            ...
                            <div class="col-xs-12 col-md-6 text-right">
                                <a href="<?php echo admin_url('employees/add_pt_challan'); ?>" type="submit" class="btn btn-info"><i class="fa fa-plus"></i> Add PT Challan</a>
                            </div>
                        </div>
                                    ...
                                    <table class="table" id="newtable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="20%">Link To Deduction</th>                               
                                                <th width="10%">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $final_total_amount = $final_adjusted_amt = 0;
                                            if(!empty($pf_challan_list)){
                                                ...
                                                foreach($pf_challan_list as $row){ 
                                                    ...
                                                    $adjusted_amt = $this->db->query("SELECT COALESCE(SUM(`pt_amount`),0) as t1 FROM `tblemployee_pf_esic_deduction` WHERE challan_id = '".$row->id."' ")->row();
                                                    
                                                    $final_total_amount += $total_amount;
                                                    $final_adjusted_amt += $adjusted_amt->t1;
                                            ?>                                                                                      
                                                    <tr>
                                                        <td><?php echo $z++;?></td>
                                                        <td>
...
<div id="tdschallan_model" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open_multipart(admin_url("employees/linkPTChallanDeduction"), array('id' => 'tdschallan-form', 'class' => 'tdschallan_form')); ?>                                    
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Link PT Deduction</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="tds_challan_id" class="control-label">PT Deduction</label>
                                <select name="pt_deduction_id[]" class="form-control selectpicker"  data-live-search="true" id="tds_challanid" multiple>
                                    <option value=""></option>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="ptchallan_id" value="0" id="tdschallan_id">
...
<script type="text/javascript">
    ...
    $('.tdschallan_id').click(function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "<?php echo base_url('admin/employees/get_pt_deduction'); ?>",
            data    : {'deduction_id' : tds_id, 'ptchallan_id' : challan_id},
