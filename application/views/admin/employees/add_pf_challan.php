                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="pf_admin" class="control-label">PF Admin</label>
                                        <input type="text" id="pf_admin" name="pf_admin" onkeyup="calculate_amt();" class="form-control amount" value="<?php echo (isset($pf_challan_info)) ? $pf_challan_info->pf_admin : ''; ?>" required>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="pf_admin" class="control-label">PF Edli</label>
                                        <input type="text" id="pf_edli" name="pf_edli" onkeyup="calculate_amt();" class="form-control amount" value="<?php echo (isset($pf_challan_info)) ? $pf_challan_info->pf_edli : ''; ?>" required>
                                    </div>
                                    <div class="form-group col-md-3">
