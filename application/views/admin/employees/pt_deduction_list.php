                    ...
                    <div class="panel-body">
                        <div class="row panelHead">
                            ...
                            <div class="col-xs-12 col-md-6 text-right">
                                <a target="_blank" href="<?php echo admin_url('employees/pt_challan_list'); ?>" type="submit" class="btn btn-info"> PT Challan List</a>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">     
                                ...
                                <div class="table-responsive">                                                         
                                    <table class="table" id="newtable">
                                        ...
                                        <tbody>
                                            <?php
                                            $pt_amount = $final_total_amount = 0;
                                            if(!empty($pt_report)){
                                                $z=1;
                                                foreach($pt_report as $row){ 
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td style="font-size: 15px;color:red;"><?php echo number_format($pt_amount, '2'); ?></td>
        ...
        <?php echo form_open_multipart(admin_url("employees/update_pf_deduction"), array('id' => 'pf-form', 'class' => 'pf_form')); ?>                                    
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Update PT Deduction</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="contribute_field" class="control-label contribute_field_text">PT Amount</label>
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="section" value="PT" id="section">
...
<div id="tdschallan_model" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open_multipart(admin_url("employees/addPTChallan"), array('id' => 'pfchallan-form', 'class' => 'tdschallan_form')); ?>                                    
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Add PT Challan</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="challan_id" class="control-label">PT Challan</label>
...
<script type="text/javascript">
    ...
    $('.tdschallan_id').click(function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "<?php echo base_url('admin/employees/get_pt_challan'); ?>",
        ...
        if (challan_id > 0){
            var tchallanurl = '<?php echo admin_url("employees/view_pt_challan/"); ?>'+challan_id;
            tdschallanlink = '<a href="'+tchallanurl+'" target="_blank" class="btn-sm btn-info">View PT Challan</a>';
