                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row panelHead">
                            ...
                            <a href="<?php echo admin_url('employees/esic_challan_list'); ?>" type="submit" class="btn btn-info"> ESIC Challan List</a>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            if(!empty($tds_report)){
                                                ...
                                                foreach($tds_report as $row){ 
                                                    ...
                                                    $ttlamount = ($row->employee_contribution+$row->employer_contribution);
        ...
        <?php echo form_open_multipart(admin_url("employees/update_pf_deduction"), array('id' => 'pf-form', 'class' => 'pf_form')); ?>                                    
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="section" value="ESIC" id="section">
...
<div id="tdschallan_model" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open_multipart(admin_url("employees/addESICChallan"), array('id' => 'pfchallan-form', 'class' => 'tdschallan_form')); ?>                                    
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Add ESIC Challan</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="challan_id" class="control-label">ESIC Challan</label>
...
<script type="text/javascript">
    ...
    $('.tdschallan_id').click(function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "<?php echo base_url('admin/employees/get_esic_challan'); ?>",
        ...
        if (challan_id > 0){
            ...
            tdschallanlink = '<a href="'+tchallanurl+'" target="_blank" class="btn-sm btn-info">View ESIC Challan</a>';
