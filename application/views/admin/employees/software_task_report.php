...
<div id="wrapper">
    <div class="content accounting-template">
		 <div class="row">
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php  echo admin_url('employees/software_task_report'); ?>">
            <div class="col-md-12">
                <div class="panel_s">
									...
									if(!empty($task_list)){
										...
										foreach($task_list as $row){
											...
											<tr>
												...
												<td><button type="button" data-toggle="modal" data-target="#edit_modal" value="<?php echo $row->id; ?>" class="btn-sm btn-<?php echo $status_class; ?> upate_status"><?php echo value_by_id("tblsoftwaretask_status", $row->status, "name"); ?></button></td>
                                                <td><button type="button" data-toggle="modal" data-target="#taskDetails" value="<?php echo $row->id; ?>" class="btn-sm btn-info details">Details</button></td>
...
<div id="edit_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <form action="<?php echo admin_url("employees/update_task_status"); ?>" method="post" enctype="multipart/form-data">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
...
<script type="text/javascript">
    $(document).on('click', '.upate_status', function () {

        var id = $(this).val();
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/employees/chage_task_status_html'); ?>",
            data: {'id': id},
