                    ...
                    <div class="panel-body">
                        <div class="row panelHead">
                            ...
                            <div class="col-xs-12 col-md-6 text-right">
                                <a href="<?php echo admin_url('employees/add_esic_challan'); ?>" type="submit" class="btn btn-info"><i class="fa fa-plus"></i> Add ESIC Challan</a>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">     
                                ...
                                <div class="table-responsive">                                                         
                                    <table class="table" id="newtable">
                                        ...
                                        <tbody>
                                            <?php
                                            $employee_amt = $employer_amt = $final_total_amount = 0;
                                            if(!empty($esic_challan_list)){
                                                $z=1;
                                                foreach($esic_challan_list as $row){ 
...
<div id="tdschallan_model" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open_multipart(admin_url("employees/linkESICChallanDeduction"), array('id' => 'tdschallan-form', 'class' => 'tdschallan_form')); ?>                                    
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Link ESIC Deduction</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="tds_challan_id" class="control-label">ESIC Deduction</label>
                                <select name="esic_deduction_id[]" class="form-control selectpicker" required='' data-live-search="true" id="tds_challanid" multiple>
                                    <option value=""></option>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="esicchallan_id" value="0" id="tdschallan_id">
...
<script type="text/javascript">
   ...
   $('.tdschallan_id').click(function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "<?php echo base_url('admin/employees/get_esic_deduction'); ?>",
            data    : {'deduction_id' : tds_id, 'esicchallan_id' : challan_id},
