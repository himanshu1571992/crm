                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="productname" name="name" required="" class="form-control" value="<?php echo (isset($product['name']) && $product['name'] != "") ? cc($product['name']) : "" ?>">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="productsubname" name="sub_name" class="form-control" value="<?php echo (isset($product['sub_name']) && $product['sub_name'] != "") ? cc($product['sub_name']) : "" ?>">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        <label for="unit_2" class="control-label">Unit 2</label>
                                        <select class="form-control selectpicker" data-live-search="true" id="unit_2" name="unit_2">
                                            <option value=""></option>
                                            <?php
                                            if (isset($unit_data) && count($unit_data) > 0) {
                                                foreach ($unit_data as $unit_key => $unit_value) {
