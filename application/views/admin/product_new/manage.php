                        ...
                        <?php echo form_open($this->uri->uri_string(), array('id' => 'product_form', 'class' => 'product-form')); ?>
                          ...
                          <div class="form-group col-md-2">
                              <select class="form-control selectpicker" id="is_varified" name="is_varified" data-live-search="true">
                                  ...
                                  <option value="1" <?php echo (isset($is_varified) && $is_varified == 1) ? 'selected':''; ?>>Verified</option>
                                  <option value="0" <?php echo (isset($is_varified) && $is_varified == 0) ? 'selected':''; ?>>Unverified</option>
                              </select>
                          </div>
                          <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <table class="table" id="newtable" style="margin-top: 30px;">
                                    ...
                                    if(!empty($temp_product_data)){
                                        foreach ($temp_product_data as $row) {

                                            $url = admin_url('product_new/temperory_product/' . $row['id']);
                                            $detail_url = admin_url('product_new/temp_product_used/' . $row['id']);
                                            $name_html = '<div class="row-options"><a target="_blank" href="' . $detail_url . '">Details</a></div>';
                                            ?>
                                             <tr>
                                                <td><?php echo $i++;?></td>
                                                <td><?php echo '<a href="' . $url . '">' . cc($row['product_name']) .$name_html. '</a>'; ?></td>
                                                <td><?php echo "Temp-PRO-" .number_series($row['id']); ?></td>
                                                <td><?php echo cc(value_by_id('tblunitmaster',$row['unit'],'name'));?></td>
