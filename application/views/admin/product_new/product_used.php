            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <?php if ($type == 'temp'){?>
                        <h4 class="no-margin">
                            <?php echo $title.' ('. value_by_id('tbltemperoryproduct',$product_id,'product_name') .')'. '('."Temp-PRO-" . number_series($product_id).')'; ?>
                        </h4>
                        <?php }else{ ?>
                        <h4 class="no-margin">
                            <?php echo $title.' ('. value_by_id('tblproducts',$product_id,'sub_name') .')'. '('."PRO - " . number_series($product_id).')'; ?>
                        </h4>
                        <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4" app-field-wrapper="date">
                                ...
                                <div class="input-group date">
                                    <input id="f_date" name="f_date" class="form-control datepicker"
                                        value="<?php if(!empty($s_fdate)){ echo $s_fdate; } ?>" aria-invalid="false"
                                        type="text">
                            ...
                            <div class="form-group col-md-4" app-field-wrapper="date">
                                ...
                                <div class="input-group date">
                                    <input id="t_date" name="t_date" class="form-control datepicker"
                                        value="<?php if(!empty($s_tdate)){ echo $s_tdate; } ?>" aria-invalid="false"
                                        type="text">
                                    <div class="input-group-addon"><i class="fa fa-calendar calendar-icon"></i></div>
                                </div>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $z++;?></td>
                                            <td>
                                                <?php echo '<a target="_blank" href="'.admin_url('leads/leads/' . $value->enquiry_id).'"> LEAD-'.number_series($value->enquiry_id).'</a>';?>
                                            </td>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                    	...
                                    	?>
													<tr>
														<td><?php echo $z++;?></td>
														<td><?php echo '<a target="_blank" href="' . admin_url('proposals/download_pdf/' . $value->id) . '" onclick="init_proposal(' . $value->id . '); ">' . format_proposal_number($value->id) . '</a>'; ?>
														</td>
                            ...
                            <div class="col-md-6 table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $z++;?></td>
                                            <td><?php echo '<a target="_blank" href="' . admin_url('estimates/download_pdf/' . $value->id) . '" onclick="init_estimate(' . $value->id . '); ">' . format_estimate_number($value->id) . '</a>';?>
                                            </td>
                                            <td><?php echo $value->total; ?></td>
                                            <td><?php echo _d($value->date); ?></td>
                                            <td><?php echo $value->qty; ?></td>
                            ...
                            <div class="col-md-6 table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $z++;?></td>
                                            <td><?php echo '<a href="' . admin_url('invoices/download_pdf/' . $value->id ).'" target="_blank">' .format_invoice_number($value->id). '</a>'; ?>
                                            </td>
                            ...
                            <div class="col-md-6 table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $z++;?></td>
                                            <td><?php echo '<a target="_blank" href="' . site_url('admin/chalan/view/' . $value->id). '" >' .$value->chalanno. '</a>'; ?>
                                            </td>
                            ...
                            <div class="col-md-6 table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $z++; ?></td>
                                            <td><?php echo '<a target="_blank" href="' . admin_url('debit_note/download_pdf/' . $value->id). '" >' .$value->number. '</a>'; ?>
                                            </td>
                            ...
                            <div class="col-md-6 table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $z++;?></td>
                                            <td><?php echo '<a target="_blank" href="' . admin_url('purchase/download_pdf/' . $value->id) . '" >' . 'PO-'.$value->number . '</a>'; ?>
                                            </td>
                                            <td><?php echo $value->totalamount; ?></td>
                                            <td><?php echo _d($value->date); ?></td>
                                            <td><?php echo $value->qty; ?></td>
                            ...
                            <div class="col-md-6 table-responsive">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $z++;?></td>
                                            <td><?php echo '<a target="_blank" href="' . admin_url('product_new/view/' . $value->product_id) . '" >' . value_by_id('tblproducts',$value->product_id,'name') . '</a>'; ?>
                                            </td>
                                            <td><?php echo $value->qty; ?></td>
                                        </tr>
                                        <?php
