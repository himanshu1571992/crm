            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <a href="<?php echo admin_url('product_new'); ?>" class="btn btn-info mright5 test pull-left display-block">Main List</a>
                            <?php
...
<script>
    $(function () {
        initDataTable('.table-product', admin_url + 'product_new/table_pending',<?php echo do_action('product_table_default_order', json_encode(array(6, 'DESC'))); ?>);
    });
</script>
</body>
</html>
