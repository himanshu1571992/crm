                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php if(check_permission_page(380,'create')){?>
                                    <a href="<?php echo admin_url('enquirytype/addunverifiedlead'); ?>" class="btn btn-info pull-right" style="margin-top:-6px; margin-right: 10px;"> Add Unverified Status</a>
                                    <?php } ?>
                                </div>
                            </div>	                   
                            ...
                            <div class="row">
                                <div class="col-md-12 table-responsive">																
                                    <table class="table" id="newtable">
                                        ...
                                        <tbody>
                                            <?php
                                            if (!empty($unverified_lead_list)) {
                                                foreach ($unverified_lead_list as $k => $row) {
                                            ?>
                                                    <tr>
                                                        <td><?php echo ++$k; ?></td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group">
                                                            <?php if(check_permission_page(380,'edit')){?>
                                                                <a href="<?php echo admin_url('enquirytype/addunverifiedlead/' . $row->id); ?>" class="btn-sm btn-primary" target="_blank" title="Edit Unverified Lead"><i class="fa fa-edit"></i></a>   
                                                            <?php }
                                                            if(check_permission_page(380,'delete')){?>    
                                                                <a href="<?php echo admin_url('enquirytype/deleteunverifiedlead/' . $row->id); ?>" class="btn-sm btn-danger _delete" target="_blank" title="Delete Unverified Lead"><i class="fa fa-trash"></i></a>   
                                                            <?php } ?>    
                                                            </div>
                                                        </td>
                                                    </tr>    
