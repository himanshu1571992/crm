...
//    $row[] = '<div class="checkbox"><input type="checkbox" value="' . $aRow['id'] . '"><label></label></div>';
    ...
    $user_name_html .= ' | <a href="' . admin_url('expenses/delete_purpose/' . $aRow['id']) . '" class="text-danger _delete">' . _l('delete') . '</a>';
   ...
   $row[] = $aRow['order'];
    ...
    $toggleActive = '<div class="onoffswitch">
        <input type="checkbox" data-switch-url="' . admin_url() . 'expenses/change_expense_purpose_status" name="onoffswitch" class="onoffswitch-checkbox" id="' . $aRow['id'] . '" data-id="' . $aRow['id'] . '" ' . $checked . '>
