...
//    $row[] = '<div class="checkbox"><input type="checkbox" value="' . $aRow['id'] . '"><label></label></div>';
    ...
    $url = admin_url('productcategory/productcategory/' . $aRow['id']);
    ...
    if(check_permission_page('74,245','delete') ){
    $user_name_html .= ' | <a href="' . admin_url('productcategory/delete/' . $aRow['id']) . '" class="text-danger _delete">' . _l('delete') . '</a>';
    }
    $user_name_html .= '</div>';
    ...
    $toggleActive = '<div class="onoffswitch">
        <input type="checkbox" data-switch-url="' . admin_url() . 'productcategory/change_product_category_status" name="onoffswitch" class="onoffswitch-checkbox" id="' . $aRow['id'] . '" data-id="' . $aRow['id'] . '" ' . $checked . '>
