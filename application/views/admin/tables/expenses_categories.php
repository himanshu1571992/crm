...
//    $row[] = '<div class="checkbox"><input type="checkbox" value="' . $aRow['id'] . '"><label></label></div>';
    ...
    $url = admin_url('expenses/add_category/' . $aRow['id']);
   ...
   // $user_name_html .= ' | <a href="' . admin_url('unit/delete/' . $aRow['id']) . '" class="text-danger _delete">' . _l('delete') . '</a>';
    ...
    $toggleActive = '<div class="onoffswitch">
        <input type="checkbox" data-switch-url="' . admin_url() . 'expenses/change_expense_category_status" name="onoffswitch" class="onoffswitch-checkbox" id="' . $aRow['id'] . '" data-id="' . $aRow['id'] . '" ' . $checked . '>
