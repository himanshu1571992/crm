                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <label for="name" class="control-label">Product Child Category *</label>
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" required data-live-search="true" id="parent_category_id" name="parent_category_id">
                                        ...
                                        if (isset($pro_category_data) && count($pro_category_data) > 0) {
                                            ...
                                            foreach ($pro_category_data as $pro_category_key => $pro_category_value) {
                                                ...
                                                <option value="<?php echo $pro_category_value['id'] ?>" <?php echo (isset($product_sub_category_data['parent_category_id']) && $product_sub_category_data['parent_category_id']==$pro_category_value['id']) ? 'selected' : "" ?>><?php echo cc($pro_category_value['name']); ?></option>
