                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name" class="control-label">Product Root Category *</label>
                                    ...
                                    <select class="form-control selectpicker" data-live-search="true" id="category_id" name="category_id">
                                        ...
                                        if (isset($pro_category_data) && count($pro_category_data) > 0) {
                                            foreach ($pro_category_data as $pro_category_key => $pro_category_value) {
                                                ?>
                                                <option value="<?php echo $pro_category_value['id'] ?>" <?php echo (isset($product_sub_category_data['category_id']) && $product_sub_category_data['category_id']==$pro_category_value['id']) ? 'selected' : "" ?>><?php echo cc($pro_category_value['name']); ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
