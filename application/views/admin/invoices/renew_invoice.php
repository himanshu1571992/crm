					...
					<div class="form-group">
					   ...
					   <div class="input-group">
                          ...
                          <?php 
                                ...
                                if (!empty($yearid)){
                                    $invoice_number = get_invoice_number(1, $yearid);
                                }else{
                                    $invoice_number = get_invoice_number(1);
                                }
                          ?>
						  <input type="text" name="number" id="invoice_number" class="form-control" value="<?php echo $invoice_number; ?>" >
                          <input type="hidden" name="financial_yearid" value="<?php echo $yearid; ?>">
                          <input type="hidden" name="billing_branch_id" value="<?php echo $branch_id; ?>">
					   </div>
					</div>
	                <div class="row">
                                           ...
                                           <div class="row">
                                                ...
                                                <div class="col-md-6 transportation_charges_div" <?php echo (!empty($invoice) && $invoice->transportation_charges > 0) ? "": 'style="display:none;"';?>>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="transportation_charges" class="form-control" value="<?php echo (!empty($invoice) && $invoice->transportation_charges > 0) ? $invoice->transportation_charges: "";?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
							...
							<table class="table credite-note-items-table items table-main-credit-note-edit no-mtop" id="myContactTable">
								...
								<tbody class="ui-sortable">
									<tr class="main" id="tr0">
										...
										<td>
											<div class="form-group">
												<input type="text" id="phonenumber0" minlength="10" maxlength="10" name="clientdata[0][phonenumber]" onBlur="checkcontno(this.value,0);" class="form-control onlynumbers contact1"><span id="phonenumberdiv1"></span>
											</div>
										</td>
										<td>
											<div class="form-group">
						...
						<table class="table credite-note-items-table items table-main-credit-note-edit no-mtop" id="myContactTable">
							...
							<tbody class="ui-sortable">
								...
								<tr class="main" id="trcc<?php echo $i;?>">
									...
									<td>
										<div class="form-group">
											<input type="text" maxlength="10" minlength="10" id="phonenumber<?php echo $i;?>" name="clientdata[<?php echo $i;?>][phonenumber]" value="<?php echo $singlecontactdata['phonenumber'];?>" onBlur="checkcontno(this.value,0);" class="form-control onlynumbers contact2"><span id="phonenumberdiv0"></span>
										</div>
									</td>
									<td>
										<div class="form-group">
            ...
            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row" style="margin-top:2%;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control rent_discount_percentage" value="<?php echo (isset($invoice) && $invoice->rent_discount_percent != '') ? $invoice->rent_discount_percent : ""; ?>" onchange="get_total_disc_rent()" name="rentproposal[finaldiscountpercentage]" id="rent_discount_percentage">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row" style="margin-top:2%;">
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label">Total Discount (%) <span style="color:red">*</span></label>
                                        <input type="number" class="form-control sale_discount_percentage" value="<?php echo (isset($invoice) && $invoice->sale_discount_percent != '') ? $invoice->sale_discount_percent : ""; ?>" onchange="get_total_disc_sale()" name="saleproposal[finaldiscountpercentage]" id="sale_discount_percentage">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="control-label">Total Discount Amt <span style="color:red">*</span></label>
              ...
              <div class="form-group">
                ...
                <!-- </div> -->
                          ...
                          <a href="javascript:void(0);" class="btn-tr btn btn-default mleft10 text-right invoice-form-submit save-as-draft transaction-submit">Save as Draft</a>
                          ...
                          <a href="javascript:void(0);" class="btn-tr btn btn-info mleft10 text-right invoice-form-submit save-and-send transaction-submit">Save &amp; Send</a>
                          <!-- <button class="btn-tr btn btn-info mleft10 text-right invoice-form-submit save-and-send transaction-submit">Save &amp; Send</button> -->
