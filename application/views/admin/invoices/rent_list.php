                ...
                <div class="panel_s">
                    ...
                    <div class="row panelHead">
                        <div class="col-xs-12 col-md-6">
                            <h4>Rent Invoice List</h4>
                        </div>
                        <div class="col-xs-12 col-md-6 text-right">
                            <a href="<?php echo admin_url('invoices/export/?service_type=1&f_date='.$date_a.'&t_date='.$date_b.'&staff_id='.$staff.'&client_id='.$client.'&status='.$stat); ?>" type="submit" class="btn btn-info">Export</a> <?php if(check_permission_page('17,18','create')){ ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="row">
           ...
           <input type="hidden" name="type" class="type" value="rent">
