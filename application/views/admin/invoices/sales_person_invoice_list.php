                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="form-group col-md-2">
                            <label for="staff_id" class="control-label">Service Type</label>
                            <select class="form-control selectpicker" id="service_type" name="service_type" data-live-search="true">
                                <option value="" disabled selected >--Select One-</option>
                                <option value="1" <?php echo (!empty($service_type) && $service_type == '1') ? 'selected':''; ?>>Rent</option>
                                <option value="2" <?php echo (!empty($service_type) && $service_type == '2') ? 'selected':''; ?>>Sales</option>
                            </select>
                        </div>
                        <div class="col-md-2" id="employee_div">
                            <div class="form-group ">
