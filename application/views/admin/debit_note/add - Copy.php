				 ...
				 <div class="col-md-6">
						...
						<select class="form-control selectpicker" name="clientid" required="" id="clientid" onchange="get_challan()" data-live-search="true">
                            ...
                            if (isset($client_branch_data) && count($client_branch_data) > 0) {
                                foreach ($client_branch_data as $client_value) {
                                    ...
                                    ?>
                                        <option value="<?php echo $client_value['id'] ?>" <?php echo (isset($debit_info->clientid) && $debit_info->clientid == $client_value['id']) ? 'selected' : "" ?>><?php echo $client_value['companyname']; ?></option>
                                        <?php
                                }
                            }
                            ?>
						...
						<select class="form-control selectpicker" name="site_id" id="site_id"  data-live-search="true" required="">
							...
							if (isset($all_site) && count($all_site) > 0) {
								foreach ($all_site as $site_key => $site_value) {
									?>
									<option value="<?php echo $site_value['id'] ?>" <?php echo (isset($debit_info->site_id) && $debit_info->site_id == $site_value['id']) ? 'selected' : "" ?>><?php echo $site_value['name'] ?></option>
									<?php
								}
							}
							?>
					...
					<div class="row">
						...
						<div class="col-md-6">
	                            ...
	                            <select required="" class="form-control selectpicker" id="invoice_id" required="" name="invoice_id" data-live-search="true">
					   ...
					   <div class="row">
                        ...
                        <div class="form-group col-md-6">
		                    ...
		                    <select required="" class="form-control selectpicker" id="debit_note_for" required="" name="debit_note_for" data-live-search="true">
		                        ...
		                        <option value="3" <?php echo (!empty($debit_info->debit_note_for) && $debit_info->debit_note_for == 3) ? 'selected' : '' ; ?> >Transportation</option>
		                    </select>
                                                ...
                                                foreach ($product_info as $single_prod_sale_det) {
                                                    ...
                                                    <tr class="trsalepro<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <input readonly="" type="text" class="form-control" name="saleproposal[<?php echo $i; ?>][prodtax]" id="saleprod_tax_<?php echo $i; ?>" value="18">
                                                        </td>  
