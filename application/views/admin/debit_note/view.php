...
?>
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php  echo admin_url('debit_note'); ?>">
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="row panelHead">
                        ...
                        <div class="col-xs-12 col-md-6 text-right">
                            <a href="<?php echo admin_url('debit_note/export?client_id='.$client.'&f_date='.$date_a.'&t_date='.$date_b); ?>" type="submit" class="btn btn-info">Export</a> <?php if(check_permission_page(25,'create')){ ?>
                    		<a href="<?php echo admin_url('debit_note/add'); ?>" type="submit" class="btn btn-info">Create Debit Note</a> <?php } ?>
                        </div>
                    </div>
								...
								<table class="table" id="newtable">
									...
									if(!empty($debitnote_list)){
										...
										foreach($debitnote_list as $row){
                                            ...
                                            $courier_info = $this->db->query("SELECT * FROM `tblcouriersend` WHERE `rel_type` = 'DN' and `rel_id` = '".$row->id."' ")->row();
											?>
											<tr>
												<td><?php echo $z++;?></td>
												<td>
												...
												<td class="">
                                                    ...
                                                    <div class="btn-group pull-right">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right toggle-menu">
                                                            <li><a  title="View" target="_blank" href="<?php echo admin_url('debit_note/download_pdf/'.$row->id.'/?output_type=I');?>" data-status="1">View PDF</a></li>
                                                            <li>
                                                                <?php
                                                                    if($row->status > 0){
                                                                ?>
                                                                    <a class="text-danger _delete" href="<?php echo admin_url('debit_note/mark_as_cancelled/'.$row->id);?>" data-status="1">CANCEL</a>
                                                                <?php
                                                                    }
                                                                ?>
                                                            </li>
                                                            <?php
                                                                if(check_permission_page(25,'edit')){
                                                                    echo '<li><a title="Edit" href="'.admin_url('debit_note/add/'.$row->id).'">Edit</a></li>';
                                                                }

                                                                if((check_permission_page(25,'delete'))){
                                                                ?>
                                                                <!-- <li><a class=" _delete" href="<?php echo admin_url('debit_note/delete/'.$row->id);?>" data-status="1">Delete</a></li> -->
                                                                <?php
                                                                }
                                                            ?>
                                                            <li>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"> Send debit note to client </h4>
      </div>
      <div class="modal-body">
        ...
        <?php
            $template_list = $this->db->query("SELECT id, template_name FROM tblemailmoduletemplate WHERE module_id = 7 AND status = 1")->result();
        ?>
        ...
        <?php echo form_hidden('template_name',"debit_note"); ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="row">
           ...
           <input type="hidden" name="section" class="section" value="DN">
  ...
  <div class="modal-dialog ">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="row">
           <input type="hidden" name="rel_id" class="rel_id" value="">
           <input type="hidden" name="rel_type" class="rel_type" value="DN">
