                    ...
                    <div class="panel-body">
						...
						<div class="row">
	                        ...
	                        <div class="col-md-4" id="employee_div">
	                            <div class="form-group ">
	                                <label for="branch_id" class="control-label">Service</label>
	                                <select class="form-control selectpicker" id="service_type" name="service_type" data-live-search="true" >
	                                    ...
	                                    <option value="2" <?php echo ($service_type == 2) ? "selected" : " "; ?> >Sale</option>
	                                    <option value="3" <?php echo ($service_type == 3) ? "selected" : " "; ?> >Both</option>
	                                ...
	                                <select class="form-control selectpicker" id="client_id" name="client_id[]" data-live-search="true" multiple="">
	                                    ...
	                                    if(!empty($client_data)){
	                                        foreach ($client_data as $row) {
	                                            ...
	                                            ?>
	                                            <option value="<?php echo $row->userid; ?>" <?php echo $selected;  ?>><?php echo $row->client_branch_name; ?></option>
	                                            <?php
	                                        }
	                                    }
	                                    ?>
	                        ...
	                        <div class="col-md-2">
		                        <div class="form-group">
		                        	<label for="min_balance" class="control-label">Min <small>(Balance)</small></label>
		                        	<input type="text" id="min_balance" name="min_balance" class="form-control" value="<?php echo (!empty($min_balance)) ? $min_balance : '' ?>">
		                        </div>
		                    </div>

		                    <div class="col-md-2">
		                        <div class="form-group">
		                        	<label for="max_balance" class="control-label">Max <small>(Balance)</small></label>
		                        	<input type="text" id="max_balance" name="max_balance" class="form-control" value="<?php echo (!empty($max_balance)) ? $max_balance : '' ?>">
		                        </div>
		                    </div>
								...
								if(!empty($client_list)){																	
									...
									foreach ($client_list as $client) {
											...
											if(!empty($f_date) && !empty($t_date)){
												...
												$where_debitnote .= " and date between '".$f_date."' and '".$t_date."'";
											} 
											...
											if(!empty($f_date) && !empty($t_date)){
												$where_onaccount .= " and date between '".$f_date."' and '".$t_date."'";
											}
											//$onaccout_amt = $this->db->query("SELECT COALESCE(SUM(ttl_amt),0) AS ttl_amount FROM `tblclientpayment`  where ".$where_onaccount." ")->row()->ttl_amount;
									        ...
									        if(!empty($f_date) && !empty($t_date)){
												$where_waveoff .= " and created_date between '".$f_date."' and '".$t_date."'";
											}
											...
											if(($min_balance == '') && ($max_balance == '')){
												...
												?>
													<tr>
														...
														<td align="center"><?php echo number_format($waveoff_amt, 2); ?></td>
								...
								?>
							        ...
							        <tfoot>
							            <tr>
											...
											<td align="center"><b><?php echo number_format($ttl_waiveoff, 2); ?></b></td>
