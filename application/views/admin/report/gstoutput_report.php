            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control selectpicker" required="" data-live-search="true" id="from" name="from">
                                        <option value="" ></option>
                                        <option value="GSTR1" <?php echo (isset($from) && $from == "GSTR1") ? "selected" : ""; ?> >GSTR1</option>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control selectpicker" required="" data-live-search="true" id="to" name="to">
                                        <option value="" ></option>
                                        <option value="GSTR1" <?php echo (isset($to) && $to == "GSTR1") ? "selected" : ""; ?> >GSTR1</option>
                        ...
                        <br>
                        <?php
                            $gstr1 = $gstr3b = $tally = $crm = "";
                            if (isset($from) && isset($to)){
                                $gstr1 = $gstr3b = $tally = $crm = "hide";
                                if (($from == "GSTR1" OR $to == "GSTR1")){
                                    $gstr1 = ""; 
                                }
                            ...
                            <table class="table" id="newtable">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan=3 class="<?php echo $gstr1; ?>" style="text-align: center;">GSTR1</th>
                                    ...
                                    <tr>
                                        <th class="<?php echo $gstr1; ?>" style="text-align: center;">CGST</th>
                                        <th class="<?php echo $gstr1; ?>" style="text-align: center;">SGST</th>
                                        <th class="<?php echo $gstr1; ?>" style="text-align: center;">IGST</th>
                                    ...
                                    <?php
                                        if (!empty($gst_output)) {
                                            ...
                                            foreach ($gst_output as $key => $row) {
                                                $url = admin_url("report/gsttaxdetails");
                                                $month = $row["month"];
                                    ?>
                                    <tr>
                                        <td style="text-align: center;"><?php echo date("M-Y", strtotime($row["month"]."-01")); ?></td>
                                        <td class="<?php echo $gstr1; ?>" style="text-align: center;"><?php echo ($row["gstr1"]["cgst"] > 0.00) ? "<a href='".$url."?gsttype=1&month=".$month."' target='_blank'>".$row["gstr1"]["cgst"]."</a>" : $row["gstr1"]["cgst"]; ?></td>
                                        <td class="<?php echo $gstr1; ?>" style="text-align: center;"><?php echo ($row["gstr1"]["sgst"] > 0.00) ? "<a href='".$url."?gsttype=1&month=".$month."' target='_blank'>".$row["gstr1"]["sgst"]."</a>" : $row["gstr1"]["sgst"]; ?></td>
                                        <td class="<?php echo $gstr1; ?>" style="text-align: center;"><?php echo ($row["gstr1"]["igst"] > 0.00) ? "<a href='".$url."?gsttype=1&month=".$month."' target='_blank'>".$row["gstr1"]["igst"]."</a>" : $row["gstr1"]["igst"]; ?></td>
                                        ...
                                        if (isset($from) && isset($to)){
                                            ...
                                            if ($gstr1 == "" && $gstr3b == ""){
                                                $cgst = ($from == "GSTR1") ? $row["gstr1"]["cgst"] - $row["gstr3b"]["cgst"] : $row["gstr3b"]["cgst"] - $row["gstr1"]["cgst"];
                                                $sgst = ($from == "GSTR1") ? $row["gstr1"]["sgst"] - $row["gstr3b"]["sgst"] : $row["gstr3b"]["sgst"] - $row["gstr1"]["sgst"];
                                                $igst = ($from == "GSTR1") ? $row["gstr1"]["igst"] - $row["gstr3b"]["igst"] : $row["gstr3b"]["igst"] - $row["gstr1"]["igst"];
                                            ...
                                            if ($gstr1 == "" && $tally == ""){
                                                $cgst = ($from == "GSTR1") ? $row["gstr1"]["cgst"] - $row["tally"]["cgst"] : $row["tally"]["cgst"] - $row["gstr1"]["cgst"];
                                                $sgst = ($from == "GSTR1") ? $row["gstr1"]["sgst"] - $row["tally"]["sgst"] : $row["tally"]["sgst"] - $row["gstr1"]["sgst"];
                                                $igst = ($from == "GSTR1") ? $row["gstr1"]["igst"] - $row["tally"]["igst"] : $row["tally"]["igst"] - $row["gstr1"]["igst"];
                                                echo '<td style="text-align: center;">'.number_format(round($cgst), 2, '.', '').'</td>';
                                                echo '<td style="text-align: center;">'.number_format(round($sgst), 2, '.', '').'</td>';
                                                echo '<td style="text-align: center;">'.number_format(round($igst), 2, '.', '').'</td>';
                                            }
                                            if ($gstr1 == "" && $crm == ""){
                                                $cgst = ($from == "GSTR1") ? $row["gstr1"]["cgst"] - $row["crm"]["cgst"] : $row["crm"]["cgst"] - $row["gstr1"]["cgst"];
                                                $sgst = ($from == "GSTR1") ? $row["gstr1"]["sgst"] - $row["crm"]["sgst"] : $row["crm"]["sgst"] - $row["gstr1"]["sgst"];
                                                $igst = ($from == "GSTR1") ? $row["gstr1"]["igst"] - $row["crm"]["igst"] : $row["crm"]["igst"] - $row["gstr1"]["igst"];
                                                echo '<td style="text-align: center;">'.number_format(round($cgst), 2, '.', '').'</td>';
                                                echo '<td style="text-align: center;">'.number_format(round($sgst), 2, '.', '').'</td>';
                                                echo '<td style="text-align: center;">'.number_format(round($igst), 2, '.', '').'</td>';
                                            }
