            ...
            <div class="panel_s">
                <div class="panel-body">
                    <div class="_buttons">
						...
						<a href="<?php echo admin_url('vendor'); ?>" class="btn btn-info mright5 test pull-left display-block">
                            <?php echo _l('vendor'); ?></a>
							<a href="<?php echo admin_url('vendor/vendor'); ?>" class="btn btn-info mright5 test pull-left display-block">
                            <?php echo _l('add_vendor'); ?></a>
                        <a href="<?php echo admin_url('vendors/vendor'); ?>" class="btn btn-info mright5 test pull-left display-block">
                            <?php echo _l('add_vendor_branch'); ?></a>
                            <!--<a href="<?php echo admin_url('ClientBranch/import'); ?>" class="btn btn-info pull-left display-block mright5 hidden-xs">
                                <?php echo _l('import_client_branch'); ?></a>-->
                                <?php } ?>
                                <a href="<?php echo admin_url('vendors/all_contacts'); ?>" class="btn btn-info pull-left display-block mright5">
                                ...
                                <?php if(has_permission('customers','','view') || have_assigned_customers()) {
                                    ...
                                    <div class="row mbot15">
                                        ...
                                        <div class="col-md-2 col-xs-6 border-right">
                                            <h3 class="bold"><?php echo total_rows('tblvendor',($where_summary != '' ? substr($where_summary,5) : '')); ?></h3>
                                            <span class="text-dark"><?php echo _l('vendor_summary_total'); ?></span>
                                        </div>
                                        <div class="col-md-2 col-xs-6 border-right">
                                            <h3 class="bold"><?php echo total_rows('tblvendor','status=1'.$where_summary); ?></h3>
                                            <span class="text-success"><?php echo _l('active_vendor'); ?></span>
                                        </div>
                                        <div class="col-md-2 col-xs-6 border-right">
                                            <h3 class="bold"><?php echo total_rows('tblvendor','status=0'.$where_summary); ?></h3>
                                            <span class="text-danger"><?php echo _l('inactive_active_vendor'); ?></span>
                                        </div>
                                        <div class="col-md-2 col-xs-6 border-right">
                                            <h3 class="bold"><?php echo total_rows('tblvendorcontacts','active=1'.$where_summary); ?></h3>
                                            <span class="text-info"><?php echo _l('vendors_summary_active'); ?></span>
                                        </div>
                                        <div class="col-md-2  col-xs-6 border-right">
                                            <h3 class="bold"><?php echo total_rows('tblvendorcontacts','active=0'.$where_summary); ?></h3>
                                            <span class="text-danger"><?php echo _l('vendors_summary_inactive'); ?></span>
                                        </div>
                                        <div class="col-md-2 col-xs-6">
                                            <h3 class="bold"><?php echo total_rows('tblvendorcontacts','last_login LIKE "'.date('Y-m-d').'%"'.$where_summary); ?></h3>
...
<script>
    $(function(){
        ...
        var tAPI = initDataTable('.table-clients', admin_url+'Vendors/table', [0], [0], CustomersServerParams,<?php echo do_action('customers_table_default_order',json_encode(array(2,'asc'))); ?>);
