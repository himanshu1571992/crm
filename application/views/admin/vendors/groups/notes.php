...
<div class="row">
 ...
 <div class="usernote hide">
    <?php echo form_open(admin_url( 'misc/add_vendor_note/'.$vendor->userid.'/customer')); ?>
...
<div class="mtop15">
    <table class="table dt-table scroll-responsive" data-order-col="2" data-order-type="desc">
            ...
            <tr>
                ...
                <div data-note-edit-textarea="<?php echo $note['id']; ?>" class="hide">
                    ...
                    <div class="text-right mtop15">
                      ...
                      <button type="button" class="btn btn-info" onclick="edit_vendor_note(<?php echo $note['id']; ?>);"><?php echo _l('update_note'); ?></button>
                  </div>
              </div>
          </td>
          <td>
        ...
        <td>
            ...
            <a href="<?php echo admin_url('misc/delete_vendor_note/'. $note['id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
            <?php } ?>
        </td>
    </tr>
    <?php } ?>
