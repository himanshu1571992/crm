...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open('admin/vendors/contact/'.$customer_id.'/'.$contactid,array('id'=>'contact-form','autocomplete'=>'off')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <img src="<?php echo contact_profile_image_url($contact->id,'thumb'); ?>" id="contact-img" class="vendor-profile-image-thumb">
                        ...
                        <div id="contact-profile-image" class="form-group<?php if(isset($contact) && !empty($contact->profile_image)){echo ' hide';} ?>">
                            <label for="profile_image" class="profile-image"><?php echo _l('vendor_profile_image'); ?></label>
                        ...
                        <?php echo render_input( 'firstname', 'vendor_firstname',$value); ?>
                        <?php $value=( isset($contact) ? $contact->lastname : ''); ?>
                        <?php echo render_input( 'lastname', 'vendor_lastname',$value); ?>
                        ...
                        <?php echo render_input( 'email', 'vendor_email',$value, 'email'); ?>
                        <?php $value=( isset($contact) ? $contact->phonenumber : ''); ?>
                        <?php echo render_input( 'phonenumber', 'vendor_phonenumber',$value,'text',array('autocomplete'=>'off')); ?>
                    ...
                    <div class="vendor_password_set_wrapper">
                        <label for="password" class="control-label">
                            <?php echo _l( 'vendor_password'); ?>
                        </label>
                        ...
                        <?php if(isset($contact)){ ?>
                        <p class="text-muted">
                            <?php echo _l( 'vendor_password_change_populate_note'); ?>
                        </p>
                        <?php if($contact->last_password_change != NULL){
                            echo _l( 'vendor_password_last_changed');
                ...
                <?php if(!isset($contact) && total_rows('tblemailtemplates',array('slug'=>'new-vendor-created','active'=>0)) == 0){ ?>
                <div class="checkbox checkbox-primary">
                    <input type="checkbox" name="donotsendwelcomeemail" id="donotsendwelcomeemail">
                    <label for="donotsendwelcomeemail">
                        <?php echo _l( 'vendor_do_not_send_welcome_email'); ?>
                    </label>
                </div>
                <?php } ?>
                ...
                <div class="checkbox checkbox-primary">
                    ...
                    <label for="send_set_password_email">
                        <?php echo _l( 'vendor_send_set_password_email'); ?>
                    </label>
                </div>
                <?php } ?>
                <hr />
