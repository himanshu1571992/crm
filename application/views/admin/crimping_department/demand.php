...
<div id="wrapper">
    <div class="content accounting-template">
		 <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php  echo admin_url('crimping_department/demand'); ?>">
            <div class="col-md-12">
                <div class="panel_s">
									...
									if(!empty($demand_list)){
										...
										foreach($demand_list as $row){	
											...
											<tr>
												...
												<td><?php echo value_by_id('tblproduction_department',$row->from_department,'name'); ?></td>
...
$(document).on('click', '.action', function() {  
    ...
    $.ajax({
        type    : "POST",
        url     : "<?php echo site_url('admin/crimping_department/get_details'); ?>",
        data    : {'id' : id},
