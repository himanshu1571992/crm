        ...
        <div class="">
            <div class="col-md-12">
                ...
                <div>
                    <div >
                        <div class="_buttons">
                            <a href="<?php echo admin_url('settings?group=bank'); ?>" class="btn btn-info mright5 test pull-left display-block">
...
<script>
    $(function () {
        initDataTable('.table-bank', admin_url + 'settings/tablebank',<?php echo do_action('bank_table_default_order', json_encode(array(6, 'DESC'))); ?>);
    });
</script>