				 ...
				 <div class="col-md-6">
					<div class="f_client_id">
					  <div class="form-group select-placeholder">
						...
						<select id="clientid" required="" name="clientid" data-live-search="true" data-width="100%" class="ajax-search<?php if(isset($invoice) && empty($invoice->clientid)){echo ' customer-removed';} ?>" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
					...
					<div class="form-group">
					   ...
					   <div class="input-group">
						  ...
						  <input type="text" name="number" id="invoice_number" class="form-control" value="" >
				 ...
				 <div class="col-md-6">
					<div class="panel_s no-shadow">
						   ...
						   <div class="form-group">
                            ...
                            <select class="form-control selectpicker" onchange="get_terms_condition()" required="" data-live-search="true" id="service_type" name="">
                                <option value=""></option>
                                <?php
                                if (isset($service_type) && count($service_type) > 0) {
                                    foreach ($service_type as $service_type_key => $service_type_value) {
                                        ?>
                                        <option value="<?php echo $service_type_value['id'] ?>"><?php echo $service_type_value['name'] ?></option>
                                        <?php
                                    }
                                }
                                ?>
							...
							<table class="table credite-note-items-table items table-main-credit-note-edit no-mtop" id="myContactTable">
								...
								<tbody class="ui-sortable">
									<tr class="main" id="tr0">
										...
										<td>
											<div class="form-group">
												<input type="text" id="phonenumber0" name="clientdata[0][phonenumber]" onBlur="checkcontno(this.value,0);" class="form-control onlynumbers">
											</div>
										</td>
										<td>
											<div class="form-group">
						...
						<table class="table credite-note-items-table items table-main-credit-note-edit no-mtop" id="myContactTable">
							...
							<tbody class="ui-sortable">
								...
								<tr class="main" id="trcc<?php echo $i;?>">
									...
									<td>
										<div class="form-group">
											<input type="text" id="phonenumber<?php echo $i;?>" name="clientdata[<?php echo $i;?>][phonenumber]" value="<?php echo $singlecontactdata['phonenumber'];?>" onBlur="checkcontno(this.value,0);" class="form-control onlynumbers">
										</div>
									</td>
									<td>
										<div class="form-group">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="no-mtop mrg3"><?php echo 'Invoice For Rent'; ?></h4>
                                <hr/>
                            </div>
                            <div class="col-md-12">
                                        ...
                                        <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop renttable">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($rent_prolist as $single_prod_rent_det) {
                                                    ...
                                                    $totpro = ((($rnt_dis_price * 18) / 100) + $rnt_dis_price);
                                                    ?>
                                                    <tr class="trrentpro<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            <input readonly="" type="text" class="form-control" id="renttax_amt_<?php echo $i; ?>" value="<?php echo (($rnt_dis_price * 18) / 100); ?>" id="total_price1">
                                                        </td>
                                        ...
                                        <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop saletable">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($sale_prolist as $single_prod_sale_det) {
                                                    ...
                                                    $totproamt = ((($sale_dis_price * 18) / 100) + $sale_dis_price);
                                                    ...
                                                    <tr class="trsalepro<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            <input readonly="" type="text" class="form-control" id="saletax_amt_<?php echo $i; ?>" value="<?php echo (($sale_dis_price * 18) / 100); ?>" id="total_price1">
                                                        </td>
						...
						<div  class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control tinymce" name="terms_and_conditions" id="terms_and_conditions"> </textarea>
							</div>
						</div>
