                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group select-placeholder">
                                        ...
                                        <select required="" class="form-control selectpicker" name="clientid" id="clientid" data-live-search="true">
                                            ...
                                            foreach($client_branch_data as $singlevalue)
                                            {
                                                ...
                                                <option value="<?php echo $singlevalue['userid'] ?>" <?php echo (isset($proformachallan_info->clientid) && $proformachallan_info->clientid == $singlevalue['userid']) ? 'selected' : "" ?>><?php echo cc($singlevalue['client_branch_name']).' - '.$singlevalue['email_id']; ?></option>
                                    ...
                                    <select class="form-control selectpicker" name="site_id" id="site_id" data-live-search="true">
                                        ...
                                        if (isset($all_site) && count($all_site) > 0) {
                                            foreach ($all_site as $site_key => $site_value) {
                                                ?>
                                                <option value="<?php echo $site_value['id'] ?>" <?php echo (isset($proformachallan_info->site_id) && $proformachallan_info->site_id == $site_value['id']) ? 'selected' : "" ?>><?php echo $site_value['name'] ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <address>
                                            <span class="billing_street">
                                                <?php $billing_street = (isset($proformachallan_info) ? $proformachallan_info->billing_street : '--'); ?>
                                                <?php $billing_street = ($billing_street == '' ? '--' : $billing_street); ?>
                                                <?php echo $billing_street; ?></span><br>
                                            <span class="billing_city">
                                                <?php $billing_city = (isset($proformachallan_info) ? $proformachallan_info->billing_city : '--'); ?>
                                                <?php $billing_city = ($billing_city == '' ? '--' : $billing_city); ?>
                                                <?php echo $billing_city; ?></span>,
                                            <span class="billing_state">
                                                <?php $billing_state = (isset($proformachallan_info) ? $proformachallan_info->billing_state : '--'); ?>
                                                <?php $billing_state = ($billing_state == '' ? '--' : $billing_state); ?>
                                                <?php echo $billing_state; ?></span>
                                            <br/>
                                            <!-- <span class="billing_country">
                                                <?php $billing_country = (isset($proformachallan_info) ? get_country_short_name($proformachallan_info->billing_country) : '--'); ?>
                                                <?php $billing_country = ($billing_country == '' ? '--' : $billing_country); ?>
                                                <?php echo $billing_country; ?></span>, -->
                                            <span class="billing_zip">
                                                <?php $billing_zip = (isset($proformachallan_info) ? $proformachallan_info->billing_zip : '--'); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <address>
                                            <span class="shipping_street">
                                                <?php $shipping_street = (isset($proformachallan_info) ? $proformachallan_info->shipping_street : '--'); ?>
                                                <?php $shipping_street = ($shipping_street == '' ? '--' : $shipping_street); ?>
                                                <?php echo $shipping_street; ?></span><br>
                                            <span class="shipping_city">
                                                <?php $shipping_city = (isset($proformachallan_info) ? $proformachallan_info->shipping_city : '--'); ?>
                                                <?php $shipping_city = ($shipping_city == '' ? '--' : $shipping_city); ?>
                                                <?php echo $shipping_city; ?></span>,
                                            <span class="shipping_state">
                                                <?php $shipping_state = (isset($proformachallan_info) ? $proformachallan_info->shipping_state : '--'); ?>
                                                <?php $shipping_state = ($shipping_state == '' ? '--' : $shipping_state); ?>
                                                <?php echo $shipping_state; ?></span>
                                            <br/>
                                            <!-- <span class="shipping_country">
                                                <?php $shipping_country = (isset($proformachallan_info) ? get_country_short_name($proformachallan_info->shipping_country) : '--'); ?>
                                                <?php $shipping_country = ($shipping_country == '' ? '--' : $shipping_country); ?>
                                                <?php echo $shipping_country; ?></span>, -->
                                            <span class="shipping_zip">
                                                <?php $shipping_zip = (isset($proformachallan_info) ? $proformachallan_info->shipping_zip : '--'); ?>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="work_no" name="work_no" class="form-control" value="<?php echo (!empty($proformachallan_info->work_no)) ? $proformachallan_info->work_no : ""; ?>">
                                    </div>

                                    <div class="col-md-6">
                                        <?php 
                                            $value = (isset($proformachallan_info) ? _d($proformachallan_info->date) : _d(date('Y-m-d')));
                                ...
                                <?php 
                                $rel_id = (isset($proformachallan_info)) ? $proformachallan_info->id : 0;
                                ?>
                                <?php echo render_custom_fields('proforma_challan', $rel_id); ?>
                            </div>
                            <div class="col-md-6">
                                <div class="panel_s no-shadow">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group select-placeholder">
                                                ...
                                                <select class="selectpicker display-block mbot15" name="status" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                    <?php foreach ($estimate_statuses as $status) { ?>
                                                        <option value="<?php echo $status; ?>" <?php echo (isset($proformachallan_info) && $proformachallan_info->status == $status) ? 'selected="selected"' : ""; ?>><?php echo format_estimate_status($status, '', false); ?></option>
                                                            <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                      ...
                                      <div class="col-md-12">
                                            <?php 
                                              $value = get_challan_number($proformachallan_info->service_type,$proformachallan_info->rel_id);
                                        ...
                                        <div class="col-md-12" style="margin-bottom:2%;">
                                            ...
                                            <select onchange="staffdropdown()" class="form-control selectpicker" data-live-search="true" id="assign" name="assign" required="">
                                                ...
                                                if (isset($group_info) && count($group_info) > 0) {
                                                    ...
                                                    $group_id = (isset($proformachallan_info)) ? $proformachallan_info->group_id : 0;
                                        ...
                                        <div class="col-md-6">
                                            <?php 
                                                ...
                                                $office_person_name = (isset($proformachallan_info) && !empty($proformachallan_info->office_person)) ? $proformachallan_info->office_person : $office_person_name;
                                                $office_person_no = (isset($proformachallan_info) && !empty($proformachallan_info->office_person_number)) ? $proformachallan_info->office_person_number : $office_person_no;
                                                $site_person_name = (isset($proformachallan_info) && !empty($proformachallan_info->site_person)) ? $proformachallan_info->site_person : '';
                                                $site_person_number = (isset($proformachallan_info) && !empty($proformachallan_info->site_person_number)) ? $proformachallan_info->site_person_number : '';
                                        ...
                                        <div class="col-md-6">
                                            <?php 
                                                echo render_input('site_person', 'Site Person', $site_person_name); 
                                            ?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php 
                                    ...
                                    <?php 
                                        $value = (isset($proformachallan_info) ? $proformachallan_info->adminnote : '');
                    ...
                    <div class="panel-body">
                        <div class="modal-body" id="stockavdv">
                            ...
                            foreach ($productdata as $singleproductdata) {
                                ...
                                $implodequery = ' OR `warehouse_id`='.$warehouse_id;
                               ...
                               // $getallrequriedcomponent = $this->db->query("SELECT tc.`name`,tc.`id`,tpc.`qty` FROM `tblproductcomponents` tpc LEFT JOIN `tblcomponents` tc ON tpc.`component_id`=tc.id where tpc.`product_id`='" . $singleproductdata['product_id'] . "'")->result_array();
                                ...
                                $getallrequriedcomponent = $this->db->query("SELECT tc.`name`,tc.`sub_name`,tc.`id`,tpc.`qty` FROM `tblproductitems` tpc LEFT JOIN `tblproducts` tc ON tpc.`item_id`=tc.id where tpc.`product_id` ='" . $singleproductdata['product_id'] . "'")->result_array();
                                ...
                                if(empty($getallrequriedcomponent)){
                                    $getallrequriedcomponent[]  = array(
                                        'name' => get_product_name($singleproductdata['product_id']),
                                        'id' => $singleproductdata['product_id'],
                                        'qty' => 1
                                    );
                                }
                                // End 
                                ...
                                foreach ($getallrequriedcomponent as $singlerequriedcomponent) {
                                    ...
                                    $checkwarehousedet = $this->db->query("SELECT sum(`qty`) as totalqty FROM `tblprostock` WHERE `pro_id`='" . $singlerequriedcomponent['id'] . "' AND `service_type`='" . $service_type . "' AND `store` = 1 AND `stock_type` = 1 AND (`warehouse_id`=" . $warehouse_id . ")  AND (staff_id = 0 || staff_id = '".get_staff_user_id()."')")->row_array();
                                           ...
                                           if(!empty($productdata)){                                            
                                            $j = 1;
                                                foreach ($productdata as $pro){
                                                    ...
                                                    $chk_product_qty = $this->db->query("SELECT sum(`qty`) as totalqty FROM `tblprostock` WHERE `pro_id`='" . $pro['product_id'] . "' AND `service_type`='" . $service_type . "' AND `store` = 1 AND `stock_type` = 1 AND `warehouse_id`=" . $warehouse_id . " AND (staff_id = 0 || staff_id = '".get_staff_user_id()."')")->row_array();
                                                    $availableqty = 0;
                                                    if ($chk_product_qty['totalqty'] > 0) {
                                                        $availableqty = $chk_product_qty['totalqty'];
                                                    }
                                                    $product_avl_qty += $availableqty;
                                                    ...
                                                    $rcolor = ($availableqty < $pro['qty']) ? 'class="bg-danger"':'';   
                                        ?>
                                                    <tr <?php echo $rcolor; ?>>
                                                        <td><?php echo $j++; ?></td>
                                                        <td><?php echo get_product_name($pro['product_id']); ?></td>
                                                        <td>
                                                            <?php echo $availableqty; ?>
                                                            <input type="hidden" class="productavailableqty" data-aqty="<?php echo $availableqty; ?>" data-qty="<?php echo $pro['qty']; ?>">
                                                        </td>
                            ...
                            <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop" id="myproTable" style="margin-top:2% !important;">
                                ...
                                <tbody class="ui-sortable" style="font-size:15px;">
                                    ...
                                    if(!empty($componentdata)){
                                        foreach ($componentdata as $singlerequriedcomponent) {

                                            $requiredqty = $singlerequriedcomponent['qty'];
                                            $checkwarehousedet = $this->db->query("SELECT sum(`qty`) as totalqty FROM `tblprostock` WHERE `pro_id`='" . $singlerequriedcomponent["product_id"] . "' AND `service_type`='" . $proformachallan_info->service_type . "' AND `store` = 1 AND `stock_type` = 1 AND (`warehouse_id`=" . $proformachallan_info->warehouse_id . ")  AND (staff_id = 0 || staff_id = '".get_staff_user_id()."')")->row_array();
                                            $availableqty = 0;
                                            if ($checkwarehousedet['totalqty'] > 0) {
                                                $availableqty = $checkwarehousedet['totalqty'];
                                            }
											...
											$deliverableqty = $singlerequriedcomponent['qty'];


                                            $remainingqty = ($singlerequriedcomponent['qty'] - $deliverableqty);

                                            ?>
                                            <tr class="main" id="tr<?php echo $k; ?>">
                                                <td width="25%" align="left">
                                                    <div class="form-group"><input type="hidden" name="componentdata[<?php echo $k; ?>][componentid]" value="<?php echo $singlerequriedcomponent['product_id']; ?>"><?php echo value_by_id('tblproducts',$singlerequriedcomponent['product_id'],'sub_name'); ?></div>
                                                </td>

                                                <td width="15" align="center"><input type="hidden" id="reqqty<?php echo $k; ?>" name="componentdata[<?php echo $k; ?>][requiredqty]" value="<?php echo $singlerequriedcomponent['qty']; ?>"><?php echo $singlerequriedcomponent['qty']; ?></td>

                                                <td width="15%" align="center"><input type="hidden" name="componentdata[<?php echo $k; ?>][availableqty]" value="<?php echo $singlerequriedcomponent['availableqty']; ?>"><?php echo $availableqty; ?></td>
                            ...
                            <div  class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control tinymce" name="note" id="note"><?php echo (!empty($proformachallan_info->note)) ? cc($proformachallan_info->note) : ""; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div  class="col-md-12" style="margin-top:50px;">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control tinymce" name="terms_and_conditions" id="terms_and_conditions"><?php echo (!empty($proformachallan_info->terms_and_conditions)) ? $proformachallan_info->terms_and_conditions : ''; ?></textarea>
                                </div>
                            </div>
...
<!--                                <button type="submit" class="btn btn-info mleft10 proposal-form-submit save-and-send transaction-submit">
                                ...
                                <h4 id="message_alert" style="color: #fd0000;display:none;">NOTE : Product Quantity is Insufficient.</h4>
                                <a href="javascript:void(0);" class="btn btn-info mleft10 proposal-form-submit save-and-send transaction-submit delivery-challan-btn" onclick="submitDeliveryChalan();"><?php echo _l('generate_chalan'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <script>
    ...
    $(document).ready(function(){
        $(".productavailableqty").each(function(){
            var available_qty = $(this).data("aqty");
            var qty = $(this).data("qty");
            // if (available_qty < qty){
            //     $("#message_alert").show();
            //     $(".delivery-challan-btn").hide();
            // }
        });
