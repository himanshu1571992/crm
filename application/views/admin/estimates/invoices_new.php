		...
		<?php
            ...
            if (isset($invoice) || ($this->input->get('rel_id') && $this->input->get('rel_type'))) {
                if ($this->input->get('rel_id')) {
                    ...
                    $rel_id = (!empty($invoice->rel_id)) ? $invoice->rel_id : '';
                    $rel_type = (!empty($invoice->rel_type)) ? $invoice->rel_type : '';
                }
            }
            $convert_type = $this->input->get('type');
            $convert_type_val = 0;
            if (!empty($convert_type)){
                $convert_type_val = $convert_type;
            }
				 ...
				 <div class="col-md-6">
					  ...
					  <div class="form-group select-placeholder">
						...
						<select required="" class="form-control selectpicker" name="clientid" id="clientid" data-live-search="true">
                            ...
                            if(!empty($client_branch_data)){
                                foreach ($client_branch_data as $key => $value) {
                                    ?>
                                    <option value="<?php echo $value->userid; ?>" <?php echo (isset($client_info->userid) && $client_info->userid == $value->userid) ? 'selected' : "" ?>><?php echo $value->client_branch_name.' - '.$value->email_id;?></option>
                                    <?php
                                }
                            }
                            ?>
                        </select>
                        <input type="hidden" name="convert_type" value="<?php echo $convert_type_val; ?>">
					...
					<div class="form-group">
					   ...
					   <div class="input-group">
						  ...
						  <input type="text" name="number" id="invoice_number" class="form-control" value="<?php echo get_invoice_number($s_type);?>" >
	                ...
	                <div class="row">
		                ...
		                <div class="col-md-6">
						  ...
						  <?php $value = (isset($invoice) && isset($invoice->payment_due_date)) ? _d($invoice->payment_due_date) : _d(date('Y-m-d'));
						  $date_attrs = array();
					...
					<div id="date_div" class="row">
					   <div class="col-md-6">
						  ...
						  $date_attrs = array();
						  if(isset($invoice) && (!empty($invoice->recurring)) && $invoice->recurring > 0 && $invoice->last_recurring_date != null) {
					...
					<div class="row">
					   <div class="col-md-6">
						...
						<input type="text" required="" name="po_wo_number" class="form-control" value="<?php if(!empty($invoice) && !empty($invoice->po_wo_number)){ echo $invoice->po_wo_number; }?>">
					   </div>
					   ...
					   <div class="form-group">
						  <div class="checkbox checkbox-danger">
							 <input type="checkbox" <?php if(isset($invoice) && !empty($invoice->cancel_overdue_reminders) && $invoice->cancel_overdue_reminders == 1){echo 'checked';} ?> id="cancel_overdue_reminders" name="cancel_overdue_reminders">
                ...
                // exit;
		                            ...
		                            <select class="form-control selectpicker" onchange="get_terms_condition()" required="" data-live-search="true" id="service_type" name="service_type">
		                                ...
		                                if (isset($service_type) && count($service_type) > 0) {
		                                    foreach ($service_type as $service_type_key => $service_type_value) {
		                                        ?>
		                                        <option value="<?php echo $service_type_value['id'] ?>" <?php if(isset($invoice) && $invoice->service_type == $service_type_value['id']){echo 'selected';} ?>><?php echo $service_type_value['name'] ?></option>
		                                        <?php
		                                    }
		                                }
		                                ?>
					   ...
					   <div class="row">
							   ...
							   <div class="form-group">
									...
									<input type="text" name="vendor_code" class="form-control" value="<?php if(!empty($invoice) && !empty($invoice->vendor_code)){ echo $invoice->vendor_code; }?>">
							   </div>
						   </div>
                                           ...
                                           <div class="row">
                                                <div class="col-md-6">
                                                    <div class="checkbox checkbox-danger">
                                                         ...
                                                         <input type="checkbox" <?php if(isset($invoice) && !empty($invoice->transportation_charges) && $invoice->transportation_charges > 0){echo 'checked';} ?> id="transportation_charges_chkbox" name="transportation_charges_chkbox">
                                                ...
                                                <div class="col-md-6 transportation_charges_div" <?php echo (!empty($invoice) && !empty($invoice->transportation_charges) && $invoice->transportation_charges > 0) ? "": 'style="display:none;"';?>>
                                                    <div class="form-group">
                                                        <label for="transportation_charges" class="control-label">Transportation Charges Amount</label>
                                                        <input type="text" id="transportation_charges" name="transportation_charges" class="form-control" value="<?php echo (!empty($invoice) && !empty($invoice->transportation_charges) && $invoice->transportation_charges > 0) ? $invoice->transportation_charges: "";?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
			...
			<div class="col-md-12">
				...
				<?php
					...
					<div class="table-responsive s_table">
							...
							<div class="col-xs-12">
								<label class="label-control subHeads"><a  class="addmorecontact" value="<?php echo isset($productcomponent) && count($productcomponent); ?>"><?php echo _l('add_more_client_person');?> <i class="fa fa-plus"></i></a></label>
							</div>
						</div>
						<?php
					}
            ...
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                                        ...
                                        <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop saletable">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($sale_prolist as $single_prod_sale_det) {
                                                    ...
                                                    $min_salepricee[] = (!empty($salepricelist)) ? min($salepricelist) : 0;
						...
						<div  class="col-md-12" style="margin-top: 15px;">
							<div class="form-group">
                                ...
                                <hr>
                                <?php if(isset($invoice) && $invoice->terms_and_conditions!=''){ ?>
                                    <textarea class="form-control tinymce" name="terms_and_conditions" id="terms_and_conditions"><?php echo (!empty($invoice->terms_and_conditions)) ? $invoice->terms_and_conditions : ""; ?></textarea>
                                    <br>
                                    <br>
                                <?php } ?>
              ...
              <div class="form-group">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                          <?php if ($value->input_type == "2"){
                                            ...
                                            ?>
                                               <select class="form-control selectpicker termsconditionfield" data-cval="<?php echo (isset($getermscondition) && !empty($getermscondition->value1)) ? $getermscondition->value1 : ''; ?>" data-row="<?php echo $k; ?>" data-title="<?php echo $value->title; ?>" data-id="<?php echo $value->id; ?>" data-live-search="true" data-defaultval="<?php echo trim($value->default_value); ?>" onchange="chkdefaltvalue('<?php echo $value->id; ?>',this.value)" id="svalue<?php echo $value->id; ?>" name="terms[<?php echo $value->id; ?>][value1]">
                                                    <option value=""></option>
                                                    <?php 
                                                        if (!empty($array_val)) {
                                ...
                                <?php if ($value->is_extra_input == '1'){ ?>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-4">
                                            <input type="text" class="form-control numericOnly" id="evalue<?php echo $value->id; ?>" name="terms[<?php echo $value->id; ?>][value2]" data-cval="<?php echo (isset($getermscondition) && !empty($getermscondition->value2)) ? $getermscondition->value2 : ''; ?>" value="<?php echo (isset($getermscondition) && !empty($getermscondition->value2)) ? $getermscondition->value2 : ''; ?>">
                                          </div>
                                      </div>
                                  </div>
                                <?php } ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control selectpicker" data-live-search="true" data-cval="<?php echo (isset($getermscondition) && $getermscondition->value2) ? $getermscondition->value2 : ''; ?>" id="evalue<?php echo $value->id; ?>" name="terms[<?php echo $value->id; ?>][value2]">
                ...
                <!-- <button class="btn-tr btn btn-info mleft10 text-right invoice-form-submit transaction-submit">
                  Save                </button> -->
                <a href="javascript:void(0);" class="btn-tr btn btn-info mleft10 text-right invoice-form-submit transaction-submit">
                  Save
                </a>
             </div>
                    </div>
...
$(".invoice-form-submit").click(function(){
    ...
    $(".termsconditionfield").each(function(){
        ...
        var existingval = $(this).data("cval");
        var days = $("#evalue"+pid).val();
        var existing_days = $("#evalue"+pid).data("cval");
        ...
        if (status == true){
            ...
            /* this is alert for change existing value */
            if (pval != existingval || (typeof(days) !="undefined" && existing_days != days)){
                alert("You have changed the terms and condition, are you sure?");
            }
