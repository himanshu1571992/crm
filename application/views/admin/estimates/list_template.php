<div class="col-md-12">
    <div class="panel_s mbot10">
        <div class="panel-body _buttons">
            ...
            ?>
            <?php if(check_permission_page(98,'create')){ ?>
                <a href="<?php echo admin_url('estimates/performerinvoice'); ?>" class="btn btn-info pull-left new new-estimate-btn"><?php echo _l('create_new_estimate'); ?></a>
            <?php } ?>
            ...
            <div class="display-block text-right">
                <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                    ...
                    <ul class="dropdown-menu width300">
                        ...
                        <li class="divider"></li>
                        <li class="<?php
                        if ($this->input->get('filter') == 'not_sent') {
                            echo 'active';
                        }
                        ?>">
                        ...
                        <?php foreach ($estimate_statuses as $status) { ?>
                            ...
                            ?>">
                                <a href="#" data-cview="estimates_<?php echo $status; ?>" onclick="dt_custom_view('estimates_<?php echo $status; ?>', '.table-estimates', 'estimates_<?php echo $status; ?>');
                                        return false;">
