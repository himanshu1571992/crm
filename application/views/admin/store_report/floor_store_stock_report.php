                                ...
                                <table class="table" id="newtable">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align='center'>
                                                <?php 
                                                echo $material_status;

                                                $product_cat_id = value_by_id('tblproducts',$value->pro_id,'product_cat_id');
                                                if($value->ref_type == 'store_cutting' && $product_cat_id == 13){
                                                ?>                                                
                                                <a class="btn-sm btn-danger _delete" href='<?php echo admin_url('store/convert_to_waste/'.$value->id); ?>'>Make Scrap</a>
                                                <?php    
                                                }
                                                ?>
                                            </td>
