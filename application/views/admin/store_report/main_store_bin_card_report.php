                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" required='' id="product_id" name="product_id" data-live-search="true">
                                                ...
                                                ?>
                                                            <option value="<?php echo $value->id; ?>" <?php echo $selected; ?>><?php echo cc($value->sub_name)." | (PRO-ID".$value->id.")"; ?></option>
                                                <?php            
                                                        }
                                                    }
                                                ?>
                        ...
                        <hr>                    
                                <div class="col-md-12 ttlbincard-div">
                                    ...
                                    <div class="col-lg-2 col-xs-12 col-md-12 total-column">
                                        <div class="panel_s">
                                            <div class="panel-body">
                                                <h3 class="text-muted _total wardedqtytext">0.00</h3>
                                                <span class="text-success">In Warded Qty</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-xs-12 col-md-12 total-column">
                                ...
                                <div class="col-md-12"> 
                                    <div class="table-responsive">  
                                        <table class="table" id="newtable">
                                            ...
                                            <?php
                                            $i = 0;
                                            $closing_amt = $openingamt = $wardingamt = $issueqtyamt = $rejectedamt = $outwardamt = 0;
                                            if(!empty($bin_card_report)){
                                                foreach ($bin_card_report as $key => $date) { 
                                                    $opening_amt = $this->store_model->getProductlogOpeningAmt($date, $product_id, $warehouse_id);
                                                    $warding_amt = $this->store_model->getProductlogWardingAmt($date, $product_id, $warehouse_id);
                                                    $issueqty_amt = $this->store_model->getProductlogIssuedqtyAmt($date, $product_id, $warehouse_id);
                                                    $rejected_amt = $this->store_model->getProductlogRejectAmt($date, $product_id, $warehouse_id);
                                                    $outward_amt = $this->store_model->getProductlogOutwardAmt($date, $product_id, $warehouse_id);
                                                    if ($opening_amt > 0 || $warding_amt > 0 || $issueqty_amt > 0 || $rejected_amt > 0 || $outward_amt > 0){
                                                        $closing_amt += ($opening_amt + $warding_amt - $issueqty_amt - $rejected_amt - $outward_amt);
                                                        $textcls = ($closing_amt > 0) ? "class='text-success'": "class='text-danger'";
                                                        $openingamt += $opening_amt;
                                                        $wardingamt += $warding_amt;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo number_format($warding_amt,2); ?></td>
...
$(document).ready(function() {
    ...
    var wardingamt = '<?php echo number_format($wardingamt,2); ?>';
    ...
    $(".ttlbincard-div").hide();
    if (openingbal > 0 || wardingamt > 0 || issueqtyamt > 0 || rejectedamt > 0 || outwardamt > 0 || closingamt > 0 ){
       
        $(".ttlbincard-div").show();
        $(".openingbaltext").html(openingbal);
        $(".wardedqtytext").html(wardingamt);
