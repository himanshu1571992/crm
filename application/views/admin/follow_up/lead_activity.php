                    ...
                    <div class="activity-feed ex31">
                      <div id="last_div" ></div>
                        ...
                        <div class="">
                          ...
                          <div class="col-md-12 reply-div reply-box<?php echo $log->id; ?>" style="display: none;">
 ...
 $(document).on("click",".view_reply", function(){
    ...
    $(this).addClass("toggle_reply");
      $.ajax({
          ...
          data    : {'id': last_reply_id, 'logid' : logid, 'section': 'lead_activity'},
          success : function(response){
            if(response != ''){
