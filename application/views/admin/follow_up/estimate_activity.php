...
<div id="wrapper">
    <div class="content accounting-template">
        <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php echo admin_url('follow_up/estimates_activity/').$estimate_id; ?>">
                <div class="col-md-12">
                    <div class="panel_s">
                                    ...
                                    <div class="panel_s no-shadow">
                                        <div class="activity-feed ex31">
                                           ...
                                           $last_id = 0;
                                                    ...
                                                    <div class="feed-item">
                                                        ...
                                                        <div class="text <?php echo ($log->status == 2) ? 'line-throught':''; ?>">
                                                            ...
                                                            if (is_admin() == 1 && $ttl_reply == 0) {
                                                                ?>
                                                                <a href="<?php echo admin_url('follow_up/delete_estimate_conversation/' . $log->id); ?>" onclick="return confirm('Are you sure you want to Delete?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                                <?php
                                                            }
                                                            ?>
                                                            ...
                                                            <br>
                                                            <br>
                                                            <?php echo get_activity_files(37, $log->id); ?>
                                            ...
                                            <!-- <div class="feed-item">
                                               <div class="date">
                                                  <span class="text-has-action" data-toggle="tooltip" data-title="06/12/2021 3:29 PM">
                                                  23 hrs ago                                                        </span>
                                               </div>
                                               <div class="text ">
                                                  <a href="#" val="2" pri="0" onclick="return false;" class="priority" ><i class="fa fa-star-o" aria-hidden="true"></i></a>
                                                  <a href="http://mustafa-pc/crm/admin/follow_up/cut_estimate_conversation/2" onclick="return confirm('Are you sure you want to cut?');"><i class="fa fa-ban" aria-hidden="true"></i></a>
                                                  <a href="http://mustafa-pc/crm/admin/follow_up/delete_estimate_conversation/2" onclick="return confirm('Are you sure you want to Delete?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                  <a href="http://mustafa-pc/crm/admin/profile/1">
                                                  <img src="http://mustafa-pc/crm/assets/images/user-placeholder.jpg"  class="staff-profile-xs-image pull-left mright5" />                                                            </a>
                                                  Abhishek - Call tomorrow                                                    
                                               </div>
                                            </div> -->
...
<script type="text/javascript">
    $(document).on('click', '.priority', function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/follow_up/udpate_estimate_priority'); ?>",
...
<script type="text/javascript">
    $(document).on('click', '#load_more', function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo site_url('admin/follow_up/get_last_estimate_conversion'); ?>",
            data: {'id': id, 'estimate_id': estimate_id},
            success: function (response) {
                if (response != '') {
 ...
 $(document).on("click",".view_reply", function(){
    ...
    $(this).addClass("toggle_reply");
      $.ajax({
          ...
          data    : {'id': last_reply_id, 'logid' : logid, 'section': 'estimate_activity'},
          success : function(response){
            if(response != ''){
