...
<div id="wrapper">
    <div class="content accounting-template">
        <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php echo admin_url('follow_up/po_activity/').$po_id; ?>">
                <div class="col-md-12">
                    <div class="panel_s">
                        <div class="panel-body">
                            <h4 class="no-margin"><?php echo $heading; ?>  <span style="padding-left: 5%;"><a href="<?php echo admin_url('reminder/add/0/1'); ?>" class="btn btn-info"><i class="fa fa-bell-o" aria-hidden="true"></i> Set Reminder</a> <button value="1" name="important_search" class="btn btn-info"><i class="fa fa-star" aria-hidden="true"></i>  Search Important</button> <button type="button" id="load_more" class="btn btn-info"><i class="fa fa-refresh fa-spin" aria-hidden="true"></i>  Load last conversation</button> <a target="_blank" href="<?php echo admin_url('purchase/download_pdf/'.$po_id); ?>" class="btn btn-info"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PO PDF</a> </span></h4>
                            ...
                            <div class="row">
                                ...
                                <div role="tabpanel" class="tab-pane" id="lead_activity">
                                    <div class="panel_s no-shadow">
                                        ...
                                        <input type="hidden" value="<?php echo $po_id; ?>" id="po_id" name="po_id">
...
<script type="text/javascript">
    $(document).on('click', '.priority', function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('admin/follow_up/udpate_po_priority'); ?>",
...
<script type="text/javascript">
    $(document).on('click', '#load_more', function () {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo site_url('admin/follow_up/get_last_po_conversion'); ?>",
 ...
 $(document).on("click",".view_reply", function(){
    ...
    $(this).addClass("toggle_reply");
      $.ajax({
          ...
          data    : {'id': last_reply_id, 'logid' : logid, 'section': 'po_activity'},
          success : function(response){
            if(response != ''){
