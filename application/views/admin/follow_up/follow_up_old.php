							...
							<div class="col-md-6">
								<div class="panel_s events animated fadeIn">
									<div class="panel-body todo-body">
											...
											<div class="row todo-title warning-bg"><div class="col-md-8"><i class="fa fa-warning"></i> Follow up pending clients (<?php echo payment_followup_count(0); ?>)</div><div class="col-md-2 text-right">Contacts</div><div class="col-md-2 text-right">Balance</div></div>
								...
								<div class="col-md-6">
									<div class="panel_s animated fadeIn">
										<div class="panel-body todo-body">
												...
												<div class="row todo-title info-bg"><div class="col-md-8"><i class="fa fa-check"></i> Follow up finished clients (<?php echo payment_followup_count(1); ?>)</div><div class="col-md-2 text-right">Contacts</div><div class="col-md-2 text-right">Balance</div></div>
...
<script>
	...
	function render_li_items(finished, obj) {
		...
		var item_order = 2;
		return '<li><div class="media"><div class="media-left no-padding-right"><div class="dragger todo-dragger"></div> <input type="hidden" value="' + finished + '" name="finished"><input type="hidden" value="' + item_order + '" name="todo_order"><input type="hidden" value="1" name="for"><div class="checkbox checkbox-default todo-checkbox"><input type="checkbox" val="1" name="todo_id" value="' + obj.id + '" '+checked+'><label></label></div></div> <div class="media-body"><p class="todo-description' + todo_finished_class + ' no-padding-left"><a target="_blank" href="<?php echo base_url("admin/follow_up/client_activity/")?>'+ obj.client_id +'">' + obj.description + '</a><a href="#" onclick="return false;" class="pull-right text-muted">' + obj.due_amt + '</a><a target="_blank" href="<?php echo base_url("admin/follow_up/payment_contact/")?>'+ obj.client_id +'" class="pull-right text-muted" style="margin-right: 75px;"><i class="fa fa-user fa-2x" aria-hidden="true"></i></a></p><small class="todo-date">' + obj.date + '</small></div></div></li>';
	}
</script>
</body>
</html>
