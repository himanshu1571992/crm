						...
						<div class="panel-body">
							...
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select class="form-control selectpicker" id="type_id" name="type" data-live-search="true">
												<option value=""></option>
												<option value="1" selected>Approved Expenses</option>
									...
									<div class="col-md-4">
										<div class="form-group expenses_div">
											<label for="expenses_id" class="control-label">Approved Expenses</label>
											<select class="form-control selectpicker" id="expenses_id" name="expenses_id[]" data-live-search="true" multiple="">
												<option value=""></option>
												<?php 
													if (!empty($approved_expenses_list)){
														foreach ($approved_expenses_list as $value) {
												?>
															<option value="<?php echo $value["id"]; ?>"><?php echo $value["expense_no"].' - '.$value["amount"]; ?></option>
												<?php			
														}
													}
												?>
										...
										<div class="form-group trip_div" style="display: none;">
											<label for="trip_id" class="control-label">Trip List</label>
											<select class="form-control selectpicker" id="trip_id" name="trip_id" data-live-search="true">
												<option value=""></option>
												<?php 
													if (!empty($trip_list)){
														foreach ($trip_list as $value) {
												?>
															<option value="<?php echo $value["id"]; ?>"><?php echo $value["number"].' - '.$value["amount"]; ?></option>
												<?php			
														}
													}
												?>
								...
								<div class="row">
									...
									<div class="<?php echo ($show_onbehalf_option == 1) ? 'col-md-8': 'col-md-4'; ?>">
										<div class="form-group">
...
<script type="text/javascript">
	...
	$("#type_id").change(function(){
		...
		if (type_id == 1){
			$(".expenses_div").show();
			$(".trip_div").hide();
			$(".trip_div option:selected").removeAttr("selected");
		}else{
			$(".expenses_div").hide();
			$(".trip_div").show();
			$(".expenses_div option:selected").removeAttr("selected");
		}
	});
