            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <h4 class="no-margin"> <?php echo $title; ?><a href="<?php echo admin_url('requests_new/add_request/1'); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">add Request</a></h4>
                        <hr class="hr-panel-heading">
                        <div class="row">
                            <div class="">
                                <div class="col-md-12 table-responsive">                                                             
                                    <table class="table ui-table" id="salary_request">
                                        <thead>
                                            <tr>
                                                <th width="5%">S.No</th>
                                                <th>Request Id</th>
                                        ...
                                        <tbody>
                                            <?php
                                                if(!empty($salary_request_list)){
                                                    $i=1;
                                                    foreach($salary_request_list as $row){  
