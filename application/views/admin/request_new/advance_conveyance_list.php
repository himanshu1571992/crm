            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <h4 class="no-margin"> <?php echo $title; ?><a href="<?php echo admin_url('requests_new/add_request/2'); ?>" class="btn btn-info pull-right" style="margin-top:-6px;">add Request</a></h4>
                            ...
                            <div class="">
                                <div class="col-md-12 table-responsive">                                                             
                                    <table class="table ui-table" id="request_table">
                                        ...
                                        <tbody>
                                            <?php
                                                if(!empty($conveyance_request_list)){
                                                    $i=1;
                                                    foreach($conveyance_request_list as $row){  
