						...
						<div class="panel-body">
							...
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="loantenure" class="control-label">Loan Tenure</label>
											<select class="form-control selectpicker" id="tenure" required="required" name="tenure_id" data-live-search="true">
												<option value=""></option>
												<?php 
													if (!empty($tenure_list)){
														foreach ($tenure_list as $value) {
												?>
