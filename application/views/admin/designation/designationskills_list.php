                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo admin_url('designation/designationskill_add/' . $row->id); ?>" class="btn btn-info btn-xs">Edit</a>
                                                        <a href="<?php echo admin_url('designation/designationskills_delete/' . $row->id); ?>" class="btn btn-danger btn-xs _delete">Delete</a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
