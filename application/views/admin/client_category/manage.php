            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <?php if(check_permission_page('87,251','create') ){ ?>
                            <a href="<?php echo admin_url('clientcategory/clientcategory'); ?>" class="btn btn-info mright5 test pull-left display-block">
...
<script>
    $(function () {
        initDataTable('.table-clientcategory', admin_url + 'clientcategory/table',<?php echo do_action('clientcategory_table_default_order', json_encode(array(3, 'DESC'))); ?>);
    });
</script>
</body>
</html>
