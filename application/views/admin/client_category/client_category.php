                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name" class="control-label"><?php echo _l('client_category_name'); ?> *</label>
                                    <input type="text" id="name" name="category_name" class="form-control" required="" value="<?php echo (isset($clientcategory['category_name']) && $clientcategory['category_name'] != "") ? cc($clientcategory['category_name']) : "" ?>">
                                </div>
								<div class="form-group">
