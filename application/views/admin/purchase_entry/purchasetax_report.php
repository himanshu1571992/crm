                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control selectpicker" multiple="" data-live-search="true" id="type" name="type[]">
                                        <option value="" ></option>
                                        <option value="PI" <?php echo (isset($type) && in_array("PI", $type)) ? 'selected' : ""; ?>>Purchase Invoice</option>
                                        <option value="PE" <?php echo (isset($type) && in_array("PE", $type)) ? 'selected' : ""; ?>>Purchase Entry</option>
                                        <option value="PDN" <?php echo (isset($type) && in_array("PDN", $type)) ? 'selected' : ""; ?>>Purchase Debit Note</option>
                                    </select>
                                </div>
<!--                                <div class="form-group col-md-3">
                            ...
                            <div class="row">  
                                ...
                                <div class="form-group col-md-2">
                                    <label for="month" class="control-label">GSTR2B</label>
                                    <select class="form-control selectpicker" multiple="" data-live-search="true" id="gstr2b_month" name="gstr2b_month[]">
                                        <option value=""></option>
                                        <option value="notset" <?php echo (isset($gstr2b_month) && in_array("notset", $gstr2b_month)) ? 'selected' : ""; ?>>Not Set</option>
                                        <?php
                                        if (!empty($month_info)) {
                                            foreach ($month_info as $row) {
                                                $selected = (isset($gstr2b_month) && in_array($row->id, $gstr2b_month)) ? 'selected' : "";
                                                ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <p style="color: red; text-align: center;"><?php echo count($purchasetax_report); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <table class="table" id="newtable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th align="center">Vendor GST Number</th>
                                    ...
                                    <tbody class="ui-sortable">
                                        ...
                                        if (!empty($purchasetax_report)) {

                                            foreach ($purchasetax_report as $key => $row) {
                                                
                                                $id = $row["id"];
                                                $rtype = $row["rtype"];
                                                $sign = ($rtype == 7) ? " - ":"";
                                                
                                                $vendor_gst_number = ($row["vendor_gst_number"]) ? $row["vendor_gst_number"] : "--";
                                                ...
                                                $output .= "<td>".$row["vendor_name"]."</td>";
                                                $output .= "<td>".$vendor_gst_number."</td>";
...
<?php init_tail(); ?>
    ...
    <div id="client_chkbox" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            echo form_open(admin_url("purchase_entry/addVendortax"), $attributes);
            ?>
            <!-- Modal content-->
...
//        }
//    });
    $(document).on("change", "#gstr2b_month", function(){
        var gst_val = $(this).val();
        if (gst_val != ""){
//            $("#month").attr("required", "");
            $("#year").attr("required", "");
