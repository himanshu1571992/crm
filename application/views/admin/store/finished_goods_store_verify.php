            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php echo form_open($this->uri->uri_string(), array('id' => 'floorstoreget', 'class' => 'proposal-form')); ?>                    
                            <div>
                                <div>
                                    <div class="row">
                                        <div class="col-md-3">  
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker" required='' data-live-search="true" onchange="getfinisedgoodsdata();" id="warehouse_id" name="warehouse_id">
                                                    <option value=""></option>
                                                    <?php
                            ...
                            <div class="col-md-12"> 
                                <div class="table-responsive">  
                                    <table class="table" id="newtable">
                                        ...
                                        <tbody class="finisedgoodsdata">
                                            <?php 
                                                    if (!empty($finished_goods_data)){
                                                        foreach ($finished_goods_data as $key => $value) {
                            ...
                            <div <?php echo (empty($finished_goods_data)) ? 'style="display:none;"': ''; ?> class="btn-bottom-toolbar text-right form-sub-btn">
...
$(document).ready(function() {
    ...
    function getfinisedgoodsdata(){
        
        var warehouse_id = $("#warehouse_id").val();
        $(".form-sub-btn").hide();
        $(".finisedgoodsdata").html("<tr><td colspan='8' class='dataTables_empty' valign='top'>No data available in table</td></tr>");
        if (warehouse_id != ""){

            $("#floorstoreget").submit();

            // var url = "<?php echo site_url('admin/store/getfinisedgoodsdata'); ?>";
            // $.ajax({
            //     type: "POST",
            //     url: url,
