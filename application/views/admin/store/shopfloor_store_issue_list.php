            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <h4 class="no-margin"><?php echo $title; ?>
                        <?php if(check_permission_page(420,'create')){ ?>
                            <a href="<?php echo admin_url('store/shopfloor_store_issue'); ?>" class="btn btn-info pull-right" style="margin-top:-6px; "> Add Shop Floor Store Issue </a>
                        <?php } ?>    
                    </h4>
                                    ...
                                    if(!empty($store_issue_list)){
                                        foreach ($store_issue_list as $key => $value) { 
                                            ...
                                            if ($value->issue_store_to == 2){
                                                ...
                                                $issue_store_to = "<span class='btn-sm btn-danger'>Finished Goods</span>";
                                            }
                                    ?>
                                        <tr>
                                            <td><?php echo ++$key; ?></td>                                                
