	...
	<body>
		...
		<table cellpadding="0" cellspacing="0">
					...
					if(!empty($request_info)){
						foreach($request_info as $row_3){
							...
							if($row_3->pettycash_id > 0 ){
								$manager_id = value_by_id('tblpettycashmaster',$row_3->pettycash_id,'staff_id');
								$pettycashmanage = get_employee_fullname($manager_id);
							}
						...
						?>
							<tr>
								...
								<td style="text-align:center; padding:8px; border: 1px solid #111;"><?php echo $cat_id; if($row_3->pettycash_id > 0 ){ echo '<small style="color: #e8283f;">(Petty Cash)<br>'.$pettycashmanage.'</small>'; } ?></td>
			...
			if($ttl_amount > 0 || $ttl_advance > 0 || $ttl_paid > 0){
				...
				<tfoot>
					<tr>
						<td colspan="10" style="background:#f0f0f0; text-align:center; padding:8px; border: 1px solid #111;"><b>Total</b></td>
				...
				echo '<tfoot>
					<tr>
						<td colspan="12" style="background:#f0f0f0; text-align:center; padding:8px; border: 1px solid #111;"><b>No Record Found!</b></td>
					</tr>
				</tfoot>';
			}
			?>
		...
		<!-- <a class="print_button" href="<?php echo admin_url('expenses/download_pdf/'.$from_date.'/'.$to_date.'/'.$staff_id);?>">Download PDF</a> -->
		
		<a class="print_button" href="<?php echo admin_url('expenses/expense_print_details/'.$from_date.'/'.$to_date.'/'.$staff_id);?>">Get Details</a>
		</form>
