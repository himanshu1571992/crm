        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <a href="<?php echo admin_url('expenses/add_category'); ?>" class="btn btn-info mright5 test pull-left display-block">
...
<script>
    $(function () {
        initDataTable('.table-units', admin_url + 'expenses/category_table',<?php echo do_action('units_table_default_order', json_encode(array(5, 'DESC'))); ?>);
    });
</script>
</body>
</html>
