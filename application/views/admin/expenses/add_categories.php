                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
								...
								<div class="form-group">
                                    <label for="name" class="control-label"><?php echo _l('dt_expense_description'); ?> </label>
							...
							<input type="file" id="expenses_category_img" name="expenses_category_img" style="width: 100%;">
						</div>
						
						<?php
							if (isset($category['expenses_category_img']) && $category['expenses_category_img'] != "") {
								?>
								<div class="form-group prodoc">
									<label class="control-label"></label>
									<img src="<?php echo base_url('uploads/expenses_category/'.$category['expenses_category_img']);?>" style="width: 150px; height: 150px;">
