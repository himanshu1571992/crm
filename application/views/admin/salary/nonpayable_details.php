                  ...
                  <tr>
					...
					<div class="col-md-12">
						...
						<div class="col-md-12">
							...
							*/
							?>
							<input type="hidden" id="pf_amt" name="pf_amt" value="0">
							<input type="hidden" id="esic_amt" name="esic_amt" value="0">
							<!-- <input type="hidden" id="pt_amt" name="pt_amt" value="0"> -->
							<input type="hidden" id="tds_amt" name="tds_amt" value="0">
...
<script type="text/javascript">
	/*$(document).on('change', '#loan', function(){
		var loan = parseFloat($(this).val());
		var amt = parseFloat(<?php echo $amt; ?>);
