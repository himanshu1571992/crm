...
?>
		...
		<h4 style="text-align:center;">Paid Salary (Personal Account)</h4>
		...
		<table style="width: 100%; text-align: center; margin-top:15px;">
			...
			<tr>   
				...
				<th style="border:1px solid #ccc;padding:6px;text-align:center;">IFSC Code</th>
				...
				foreach ($paid_info as $row) {
					?>
						<tr>   
							...
							<td style="border:1px solid #ccc;padding:5px;"><?php if(!empty($row->ifsc_code)){ echo $row->ifsc_code; }else{ echo '--';} ?></td>
