...
<div id="wrapper">
    <div class="content accounting-template">
		 <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php  echo admin_url('salary/export_report'); ?>">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                    <div class="row">
                    	<div class="col-md-12"><h4 class="no-margin">Export Salary Report</h4></div>	
                	</div>
					...
					<div class="row">
						...
						<div class="form-group col-md-3">
							<label for="type" class="control-label">Export Type *</label>
							<select class="form-control" id="type" name="type" required="">
								<option value="" disabled selected >--Select One-</option>
								<option value="1">Salary Account</option>
								<option value="2">Full Export</option>
							</select>
						</div>

						
						<div class="form-group col-md-2 float-right" style="margin-top: 22px;">
							<button class="form-control btn-info" type="submit" value="print">Export</button>
						</div>
