                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" <?php if(isset($_GET['rel_id'])){echo"readonly "; }?> data-live-search="true" id="source" name="source[]" multiple>
                                                ...
                                                if (isset($all_source) && count($all_source) > 0) {
                                                    ...
                                                    foreach ($all_source as $source_key => $source_value) {
                                                        ...
                                                        <option value="<?php echo $source_value['id'] ?>" <?php echo $selected; ?>><?php echo $source_value['name'] ?></option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
<?php
if($proposal->revice_id > 0){
    $r_id = $proposal->revice_id;
}else{
    $r_id = $proposal->id;
}
if(!empty($rent_prolist)){
    $quotation_number = get_revice_quotation_number(1,$r_id);
}else{
    $quotation_number = get_revice_quotation_number(2,$r_id);
}
?>
<input type="hidden" name="revice_id" value="<?php echo $r_id; ?>">

                                        <div class="form-group" app-field-wrapper="number">
                                            <label for="number" class="control-label">Quotation Number</label>
                                            <input type="text" id="number" name="number" class="form-control" value="<?php echo $quotation_number; ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group select-placeholder">
                                            ...
                                            <select name="status" class="selectpicker" data-width="100%" <?php echo $disabled; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                ...
                                                <?php foreach ($statuses as $status) { ?>
                                                    ...
                                                    <option value="<?php echo $status; ?>" <?php echo ($status == 5) ? 'selected' : ''; ?>><?php echo format_proposal_status($status, '', false); ?></option>
                                            ...
                                            <select class="form-control selectpicker" id="city" name="city" data-live-search="true">
                                                ...
                                                if (isset($all_city_data) && count($all_city_data) > 0) {
                                                    ...
                                                    foreach ($all_city_data as $city_key => $city_value) {
                                                        ...
                                                        <option value="<?php echo $city_value['id'] ?>" <?php echo (isset($proposal->city) && $proposal->city == $city_value['id']) ? 'selected' : "" ?>><?php echo cc($city_value['name']); ?></option>
                                        ...
                                        <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop renttable">
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 35px !important;"><?php echo 'SAC Code'; ?></td>

                                                    <td style="width: 35px !important;"><?php echo 'Weight'; ?></td>
                                                    ...
                                                    <td style="width: 45px !important;"><?php echo 'View Price'; ?></td>
                                                ...
                                                foreach ($lead_prod_rent_det as $single_prod_rent_det) {
                                                    ...
                                                    <tr class="trrentpro<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a target="_blank" href="<?php echo base_url('admin/product_new/view/'.$single_prod_rent_det['id']); ?>">
...
?>
  <input type="hidden" id="qoute_for" value="<?php echo $qoute_for; ?>">
                                ...
                                <textarea class="form-control tinymce" name="terms_and_conditions" id="terms_and_conditions"><?php if(isset($proposal) && $proposal->terms_and_conditions!=''){ echo $proposal->terms_and_conditions; } ?></textarea>   
