                            ...
                            <div class="col-md-6">
                                <!-- <div class="f_client_id">
                                    <div class="form-group select-placeholder">
                                        ...
                                        ?>" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                    <option value="<?php echo $client_info->userid; ?>" selected><?php echo $client_info->client_branch_name; ?></option>
                                        </select>
                                    </div>
                                </div> -->
                                        ...
                                        <select required="" class="form-control selectpicker" name="clientid" id="clientid" data-live-search="true">
                                            ...
                                            if(!empty($client_branch_data)){
                                                foreach ($client_branch_data as $key => $value) {
                                                    ?>
                                                    <option value="<?php echo $value->userid; ?>" <?php echo (isset($client_info->userid) && $client_info->userid == $value->userid) ? 'selected' : "" ?>><?php echo cc($value->client_branch_name).' - '.$value->email_id;?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <!-- <div class="form-group">
                                   ...
                                   <div class="input-group">
                                      ...
                                      <input type="text" name="number" id="estimate_number" class="form-control" value="<?php echo get_pi_number($s_type); ?>" >
                                    ...
                                    <select class="form-control selectpicker" onchange="get_terms_condition()" data-live-search="true" id="service_type" name="service_type">
                                        ...
                                        if (isset($service_type) && count($service_type) > 0) {
                                            foreach ($service_type as $service_type_key => $service_type_value) {
                                                ?>
                                                <option value="<?php echo $service_type_value['id'] ?>" <?php echo ($s_type == $service_type_value['id']) ? "selected" : "";?>><?php echo cc($service_type_value['name']); ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                                                   ...
                                                   <option value="">--Select One--</option>
                                                    ...
                                                    if(!empty($bank_info)){
                                                         foreach ($bank_info as $bank_key => $bank_value) {
                                                            ?>
                                                         <option value="<?php echo $bank_value->id; ?>" <?php if($bank_value->id == 3){ echo 'selected'; } ?>><?php echo cc($bank_value->name); ?></option>
                                                    <?php
                                                       }
                                                      }
                                                    ?>
...
<!--                                            <select onchange="staffdropdown()" class="form-control selectpicker" multiple data-live-search="true" id="assign" name="assignid[]">
                                    ...
                                    <select required="" class="form-control selectpicker" id="tax_type" name="tax_type" data-live-search="true">
                                        <?php
                                            if (isset($proposal) && !empty($proposal)){
                                               $tax_type =  (!empty($proposal->tax_type)) ? $proposal->tax_type : '';
                                            }else{
                                               $tax_type =  (!empty($estimate->tax_type)) ? $estimate->tax_type : '';
                                            }
                                        ?>
                                        <option value=""></option>
                                        <option value="1" <?php echo ($tax_type == 1) ? 'selected' : '' ; ?> >CGST+SGST</option>
                                        <option value="2" <?php echo ($tax_type == 2) ? 'selected' : '' ; ?> >IGST</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <?php
                                    if (isset($proposal) && !empty($proposal)){
                                       $pdf_line_breakvalue = (isset($proposal) ? $proposal->pdf_line_break : 0);
                                    }else{
                                       $pdf_line_breakvalue = (isset($estimate) ? $estimate->pdf_line_break : 0);
                                    }
                                     ?>
                                                    ...
                                                    <tr class="trrentpro<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            if($single_prod_rent_det['temp_product'] == 0){
                                                                $link = base_url('admin/product_new/product/'.$single_prod_rent_det['pro_id']);
                                                            }else{
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="rentproposal[<?php echo $i; ?>][hsn_code]" readonly="" value="<?php echo $single_prod_rent_det['sac_code']; ?>">
                                                        </td>
                                                ...
                                                foreach ($sale_prolist as $single_prod_sale_det) {
                                                   ...
                                                   // $totproamt = $prodproposalprice - (($prodproposalprice * $single_prod_sale_det['discount']) / 100);
                                                    ...
                                                    <tr class="trsalepro<?php echo $i; ?>">
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($single_prod_sale_det['temp_product'] == 0){
                                                                    $link = base_url('admin/product_new/product/'.$single_prod_sale_det['pro_id']);
                                                                }else{
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="rentproposal[<?php echo $i; ?>][unit]" readonly="" value="<?php echo get_product_unit($single_prod_sale_det['pro_id'], $single_prod_sale_det['temp_product']); ?>">
                                                        </td>
                                                        <td>
                                ...
                                <tbody class="ui-sortable">
                                    ...
                                    if (count($sale_othercharges) > 0) {
                                        ...
                                        <tr id="trsale0">
                                            ...
                                            <?php if (isset($clientsate) && $clientsate == get_staff_state()) { ?>
                                                <td>
                                                    <div class="form-group">
                        ...
                        <div  class="col-md-12" style="margin-top: 15px;">
                            <div class="form-group">
                                ...
                                <!-- <textarea class="form-control tinymce" name="terms_and_conditions" id="terms_and_conditions"><?php
                                    ...
                                    ?></textarea> -->
                                    <textarea class="form-control tinymce" <?php echo (isset($estimate) && $estimate->terms_and_conditions!='') ? '':'style="display:none;"'; ?> name="terms_and_conditions" id="terms_and_conditions"><?php if (isset($estimate) && $estimate->terms_and_conditions != '') { echo $estimate->terms_and_conditions; } ?></textarea>
...
<?php } ?>
    ...
    function get_total_price_per_qty_rent(value)
    {
        ...
        //alert(price+' Q '+qty+' W '+weight+' M '+months+' D '+days+' T '+tax);
...
$(document).ready(function() {
  ...
  if (typeof(relsection_id) != 'undefined'){
    $.ajax({
          ...
          data    : {'slug' : 'proforma_invoice','rel_id' : relsection_id},
          success : function(response){
              if(response != ''){
