...
?>
  <input type="hidden" id="qoute_for" value="<?php echo $qoute_for; ?>">
                                ...
                                <hr>
                                <textarea class="form-control tinymce" <?php echo (isset($proposal) && $proposal->terms_and_conditions!='') ? '': 'style="display:none;"'; ?> name="terms_and_conditions" id="terms_and_conditions"><?php if(isset($proposal) && $proposal->terms_and_conditions!=''){ echo $proposal->terms_and_conditions; } ?></textarea>
