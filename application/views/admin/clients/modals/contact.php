                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" data-live-search="true" id="department_id" name="department_id" required="">
                                <option value=""></option>
                                <?php
                                if (isset($department_list) && count($department_list) > 0) {
                                    foreach ($department_list as $department_key => $department_value) {
                                        ?>
                                        <option value="<?php echo $department_value->id; ?>" <?php echo (isset($contact->department_id) && $contact->department_id == $department_value->id) ? 'selected' : "" ?>><?php echo cc($department_value->name); ?></option>
                                        <?php
                                    }
                                }
                                ?>
                        ...
                        <?php echo render_input( 'phonenumber', 'client_phonenumber',$value,'text',array('autocomplete'=>'off')); ?><span id="phonenumberdiv1"></span>
                        <div class="form-group">
