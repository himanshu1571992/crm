        ...
        <div class="row">
            ...
            <div class="panel_s">
                <div class="panel-body">
                    <div class="_buttons">
                        <?php if(check_permission_page(80,'create') ){ ?>
                        <a href="<?php echo admin_url('ClientBranch/branch'); ?>" class="btn btn-info mright5 test pull-left display-block">
                            <?php echo _l('new_client_branch'); ?></a>
                            <a href="<?php echo admin_url('ClientBranch/import'); ?>" class="btn btn-info pull-left display-block mright5 hidden-xs">
                                ...
                                <?php } ?>
                                <a href="<?php echo admin_url('ClientBranch/all_contacts'); ?>" class="btn btn-info pull-left display-block mright5">
...
<?php init_tail(); ?>
<div class="modal" id="salespersonmodel">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body salesperson_html">
        
      </div>
      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="button" class="btn btn-danger close_model" data-bs-dismiss="modal">Close</button>
      </div>
...
<script>
    ...
    function show_sales_parson(clientbranchid){
        $("#salespersonmodel").modal("show");
        var aurl = '<?php echo admin_url('ClientBranch/assignsalesperson/'); ?>'+clientbranchid
        $.post(aurl, function(data){
            $(".salesperson_html").html(data);
