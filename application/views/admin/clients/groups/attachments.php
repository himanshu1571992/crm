...
<h4 class="no-mtop bold">Purchase Order Files
    <!-- <br />
...
<?php echo form_open_multipart(admin_url('clients/upload_attachment/'.$client_id),array('class'=>'dropzone','id'=>'client-attachments-upload')); ?>
