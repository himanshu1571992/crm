<?php if(isset($client)){ 
$where = "l.client_id = '".$client->userid."'";
if(!empty($_GET)){
...
$quotation_list = $this->db->query("SELECT p.* from `tblproposals` as p LEFT JOIN tblleads as l ON p.rel_id = l.id where ".$where." ORDER BY p.id desc ")->result();
?>
<h4 class="customer-profile-group-heading">Quotations</h4>
<div class="row">
    <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php echo admin_url('clients/quotation_search'); ?>">
