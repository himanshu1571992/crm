   ...
   <div class="row">
      ...
      <?php }
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation">
                                        <a href="#company_details" class="company_details" aria-controls="company_details" role="tab" data-toggle="tab" aria-expanded="false">Company Details</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                            ...
                                            <div class="col-md-9">
                                                <div class="col-md-4">	
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="epic_no" name="epic_no" class="form-control" value="<?php echo $epic_no; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="password" class="control-label"><?php echo _l('company_branch_password'); ?>*</label>
                                                        <input type="password" id="password" required="" name="password" class="form-control employee_info" data-tab="parsonal_details" value="">
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="employee_id" name="employee_id" required="" class="form-control employee_info" data-tab="parsonal_details" value="<?php echo (isset($member['employee_id']) && $member['employee_id'] != "") ? $member['employee_id'] : "" ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="epf_no" name="epf_no" class="form-control digits" value="<?php echo $epf_no; ?>">
                                                    </div>
                                                    <br>
                                                    <br>
                                                    <div class="form-group">
                                                        <label for="previous_year" class="control-label">Can Login In Previous Year</label>
                                                        <input type="checkbox" id="previous_year" name="canBackDateEntry" <?php echo (isset($member) && $member["canBackDateEntry"] == 1) ? "checked":""; ?> value="1">
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="father_husband_name" required="" name="father_husband_name" class="form-control employee_info" data-tab="parsonal_details"  value="<?php echo (isset($member['father_husband_name']) && $member['father_husband_name'] != "") ? $member['father_husband_name'] : "" ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <?php
                                                            $gender = "";
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="user_id" required="" name="user_id" class="form-control employee_info" data-tab="parsonal_details"  value="<?php echo $user_id; ?>">
                                                    </div>
                                                    <?php if (isset($member)){ ?>    
                                                    <div class="form-group">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="company_details">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="reporting_branch_id" class="control-label">Employee Reporting Branch*</label>
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="reporting_branch_id" name="reporting_branch_id" data-live-search="true">
                                                        <option value=""></option>
                                                        <?php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="monthly_salary" required="" name="monthly_salary" class="form-control employee_info" data-tab="company_details" value="<?php echo $monthly_salary; ?>" >
                                                </div>
                                                <div class="form-group">
                                                    <label for="working_from" class="control-label"><?php echo _l('staff_working_from'); ?>*</label>
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="working_from" name="working_from"  data-live-search="true">
                                                        <option value="" disabled selected>--Select One--</option>
                                                        <?php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="taxable" name="taxable"  data-live-search="true">
                                                            <option value="" disabled selected>--Select One--</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="paid_leave_time" name="paid_leave_time"  data-live-search="true">
                                                            <option value="" disabled selected>--Select One--</option>
                                                            <?php
                                                            for($month=1; $month<=12; $month++){									
                                                                    ?>
                                                                    <option value="<?php echo $month ?>" <?php if(!empty($member) && $member['paid_leave_time'] == $month){ echo 'selected';}?>><?php echo $month.' Month' ?></option>
                                                                    <?php									
                                                            } 									
                                                            ?>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" id="calling_number" multiple="" name="calling_number[]"  data-live-search="true">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="payment_mode" name="payment_mode"  data-live-search="true">
                                                        <option value="" disabled selected>--Select One--</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="working_to" name="working_to"  data-live-search="true">
                                                            <option value="" disabled selected>--Select One--</option>
                                                            <?php
                                                            for($hours=0; $hours<24; $hours++){
                                                                    for($mins=0; $mins<60; $mins+=30){
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="admin" name="admin"  data-live-search="true">
                                                            <option value="" disabled selected>--Select One--</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="staff_type_id" name="staff_type_id" data-live-search="true">
                                                            <option value=""></option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="employee_group" name="employee_group[]" multiple  data-live-search="true">
                                                            <option value=""></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="branch_id" name="branch_id[]" multiple  data-live-search="true">
                                                            <option value=""></option>
                                                            <?php
                                                            if(isset($member['branch_id']) && $member['branch_id']!='')
                                                            {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker employee_info" data-tab="company_details" required="" id="designation_id" name="designation_id"  data-live-search="true">
                                                            <option value=""></option>
                                                            <?php
                                                ...
                                                <div class="form-group date">
                                                    ...
                                                    <input type="text" id="joining_date" required="" name="joining_date" class="form-control datepicker employee_info" data-tab="company_details" value="<?php if(isset($member['joining_date']) && $member['joining_date'] != "0000-00-00"){ echo date('d/m/Y',strtotime($member['joining_date'])); }else{echo date('d/m/Y');}?>">
                                                </div>
                                                <div class="form-group contract" hidden="">
                                                    <label for="contract_from_date" class="control-label">Contract From Date </label>
                                                    <input type="text" id="contract_from_date" required="" name="contract_from_date" class="form-control datepicker employee_info" data-tab="company_details" value="<?php if(isset($member['contract_from_date']) && $member['contract_from_date'] != "0000-00-00"){ echo date('d/m/Y',strtotime($member['contract_from_date'])); }else{echo date('d/m/Y');}?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="superior_id" class="control-label">Select Superior</label>
                                                    <select class="form-control selectpicker" id="superior_id" name="superior_id"  data-live-search="true">
                                                            <option value=""></option>
                                                            <?php
                                                    ...
                                                    <select class="form-control selectpicker" id="warehouse_id" name="warehouse_id"  data-live-search="true">
                                                            ...
                                                            if(!empty($warehouse_info)){
                                                                    foreach ($warehouse_info as $row) {
                                                                            ?>
                                                                            <option value="<?php echo $row->id; ?>" <?php if(!empty($member) && $member['warehouse_id'] == $row->id){ echo 'selected';}?>><?php echo $row->name; ?></option>
                                                                            <?php
                                                                    }
                                                            }
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="text" id="gross_salary" required="" name="gross_salary" class="form-control employee_info" data-tab="company_details" value="<?php echo $gross_salary; ?>" >
                                                </div>
                                                <div class="form-group">
                                                    <label for="last_expense_date_limit" class="control-label">Expense Days Limit*</label>
                                                    <input required="" type="text" id="last_expense_date_limit" name="last_expense_date_limit" class="form-control employee_info" data-tab="company_details" value="<?php echo (isset($member['last_expense_date_limit']) && $member['last_expense_date_limit'] != "") ? $member['last_expense_date_limit'] : "" ?>">
                                                </div>
                                                <div class="form-group contract" hidden="">
                                                    <label for="contract_to_date" class="control-label">Contract To Date </label>
                                                    <input type="text" id="contract_to_date" required="" name="contract_to_date" class="form-control datepicker employee_info" data-tab="company_details" value="<?php if(isset($member['contract_to_date']) && $member['contract_to_date'] != "0000-00-00"){ echo date('d/m/Y',strtotime($member['contract_to_date'])); }else{echo date('d/m/Y');}?>">
                                                </div>
                                                
                                            </div>
                                            <div class="col-md-12">
                                                <h4>Employee Relieving Details</h4>
                                                <hr />
                                                <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" id="relieving_date" name="relieving_date" class="form-control datepicker" value="<?php if(isset($member['relieving_date']) && $member['relieving_date'] != "0000-00-00"){ echo date('d/m/Y',strtotime($member['relieving_date'])); }?>">
                                                    </div>
                                                    <div class="form-group col-md-6">
       ...
       <div class="col-md-12">
               <div class="panel_s">
                   <div class="panel-body">
                       <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#relieving_document" aria-controls="other_details" role="tab" data-toggle="tab" aria-expanded="false">Relieving Document</a>
                            </li>
                            <li role="presentation">
                                <a href="#employee_letters" aria-controls="other_details" role="tab" data-toggle="tab" aria-expanded="false">Employee Letters</a>
                            </li>
                            <li role="presentation">
                                <a href="#salary_details" aria-controls="other_details" role="tab" data-toggle="tab" aria-expanded="false">Salary Increment Details</a>
                            </li>
                        </ul>
                        <?php
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="joining_document">
                                <div class="col-md-12">
            ...
            //                                                $staff_id = $member['staffid'];
            //                                                $pre_salary_data = $this->db->query("SELECT monthly_salary, updated_at FROM tblstafflog WHERE `staffid` = '".$staff_id."' AND `approval_status` = 1 ORDER BY id DESC")->result();
            //                                                $i = 1;
            //                                                if (!empty($pre_salary_data)){
            //                                                    
            //                                                    foreach ($pre_salary_data as $val) {
            //                                                        if ($member["monthly_salary"] !== $val->monthly_salary){
            //                                                            $mes = "";
                                                    ?>                    
            <!--                                                            <tr>
                                                                            <td><?php echo $i++; ?></td>
                                                                            <td><?php echo ($val->updated_at != "0000-00-00 00:00:00") ? date("d-M-Y", strtotime($val->updated_at)) : ""; ?></td>
            ...
            //                                                    }
            //                                                }
            //                                                if($member["monthly_salary"] !== $member["previous_monthly_salary"]){
            //                                                    $mes = "";
                                                    ?>
            <!--                                                            <tr>
                                                                            <td><?php echo $i++; ?></td>
                                                                            <td><?php echo ($member["datecreated"] != "0000-00-00 00:00:00") ? date("d-M-Y", strtotime($member["datecreated"])) : ""; ?></td>
                                                                            <td><?php echo $member["previous_monthly_salary"]; ?></td>
                                                                        </tr>-->
                                                    <?php                    
            //                                                }
            //                                            }
