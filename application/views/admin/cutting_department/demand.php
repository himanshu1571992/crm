...
<div id="wrapper">
    <div class="content accounting-template">
		 <div class="row">
            ...
            <form method="post" id="salary_form" enctype="multipart/form-data" action="<?php  echo admin_url('cutting_department/demand'); ?>">
            <div class="col-md-12">
                <div class="panel_s">
...
$(document).on('click', '.action', function() {  
    ...
    $.ajax({
        type    : "POST",
        url     : "<?php echo site_url('admin/cutting_department/get_details'); ?>",
        data    : {'id' : id},
