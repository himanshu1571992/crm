...
<div class="content">
   ...
   <div class="row">
      ...
      <div class="col-md-2">
         ...
         <?php echo prodcutwise_sale_report_tab('quotation');?>
                 ...
                 <tbody>
                  ...
                  if(!empty($lead_list)){
                      ...
                      <tr>
                          ...
                          <td class="text-center"><a href="<?php echo admin_url("productwise_report/quotation_list/".$value->id."?is_sale=0&f_date=".$f_date."&t_date=".$t_date."");?>" target="_blank"><?php echo $value->rent_qty; ?></a></td>                       
                          <td class="text-center"><a href="<?php echo admin_url("productwise_report/quotation_list/".$value->id."?is_sale=1&f_date=".$f_date."&t_date=".$t_date."");?>" target="_blank"><?php echo $value->sale_qty; ?></a></td>
