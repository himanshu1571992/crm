            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <h4 class="no-margin">Manufacturing Stock Approval</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group" app-field-wrapper="adminnote">
                                        ...
                                        <textarea id="adminnote" name="adminnote" style="height: 83px; width: 595px;" class="form-control" disabled="" rows="4"><?php echo $manufacture_info->remark; ?></textarea>
                                    </div>
