                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            ...
                            <?php if(check_permission_page('128,260','create') ){ ?>
                            <a href="<?php echo admin_url('requests/add_category'); ?>" class="btn btn-info mright5 test pull-left display-block">
                                <?php echo _l('new_requiest_category'); ?>
                            </a>
                            <?php 
                            }
                            ?>
...
<script>
    $(function () {
        initDataTable('.table-units', admin_url + 'requests/category_table',<?php echo do_action('units_table_default_order', json_encode(array(5, 'DESC'))); ?>);
    });
</script>
</body>
</html>
