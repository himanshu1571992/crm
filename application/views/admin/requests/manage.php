        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <a href="<?php echo admin_url('requests/request'); ?>" class="btn btn-info mright5 test pull-left display-block">
                                <?php echo 'New Request'; ?>
                            </a>
...
<script>
    $(function () {
        initDataTable('.table-units', admin_url + 'requests/table',<?php echo do_action('units_table_default_order', json_encode(array(4, 'DESC'))); ?>);
    });
</script>
</body>
</html>
