                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name" class="control-label"><?php echo _l('requiest_category'); ?> *</label>
								...
								<div class="form-group">
							<label for="requests_category_img" class="control-label"><?php echo _l('expenses_category_image'); ?></label>
							<input type="file" id="requests_category_img" name="requests_category_img" style="width: 100%;">
						</div>
						
						<?php
							if (isset($category['requests_category_img']) && $category['requests_category_img'] != "") {
								?>
								<div class="form-group prodoc">
									<label class="control-label"></label>
									<img src="<?php echo base_url('uploads/requests_category/'.$category['requests_category_img']);?>" style="width: 150px; height: 150px;">
