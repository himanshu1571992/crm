							...
							<?php echo form_open($this->uri->uri_string(), array('id' => 'enquiry-form', 'class' => 'enquiry-form', 'enctype' => 'multipart/form-data')); ?>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<input type="text" id="phone_no_1" name="clients[phone_no_1]" class="form-control onlynumbers1" maxlength="10" minlength="10" value="<?php echo (isset($lead['phonenumber']) && $lead['phonenumber'] != "") ? $lead['phonenumber'] : "" ?>"><span id="phone_no_1div"></span>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="text" id="client_person_name" name="clients[client_person_name]" class="form-control" value="<?php echo (isset($lead['client_person_name']) && $lead['client_person_name'] != "") ? $lead['client_person_name'] : "" ?>">
											</div>
										...
										<div class="col-md-6">	
													...
													<select class="form-control selectpicker cmpbranch <?php if(isset($lead['company']) & $lead['company']!=''){?>hide<?php }?>" id="client_branch_id" name="clientbranch[client_branch_id]" data-live-search="true">
														...
														if (isset($client_branch_data) && count($client_branch_data) > 0) {
															...
															{?>
																 ...
																 {
																?>
																<option value="<?php echo $singlevalue['userid'] ?>" <?php echo (isset($lead['client_branch_id']) && $lead['client_branch_id'] == $singlevalue['userid']) ? 'selected' : "" ?> ><?php echo cc($singlevalue['client_branch_name']).' - '.$singlevalue['email_id'] ?></option>
														<?php
																 }?>
																  </optgroup >
																 <?php
											...
											<div class="form-group">
												...
												<input type="email" id="email_id" name="clients[email_id]" class="form-control" value="<?php echo (isset($lead['email']) && $lead['email'] != "") ? $lead['email'] : "" ?>">
											</div> 
											<div class="form-group">
								...
								<div class="table-responsive s_table">
										<table class="table credite-note-items-table items table-main-credit-note-edit no-mtop" id="myTable">
											...
											<tbody class="ui-sortable">
												<tr class="main" id="tr0">
													...
													<td>
														<div class="form-group">
															<input type="text" id="phonenumber0"  maxlength="10" minlength="10" name="clientdata[0][phonenumber]" onBlur="checkcontno(this.value,0);" class="form-control onlynumbers"><span id="phonenumberdiv"></span>
														</div>
													</td>
													<td>
														<div class="form-group">
									...
									<div class="table-responsive s_table">
										...
										<div class="col-xs-12">
											<label class="label-control subHeads"><a  class="addmore" value="<?php echo count($contactdata); ?>"><?php echo _l('add_more_client_person');?> <i class="fa fa-plus"></i></a></label>
										</div>
									</div>
															...
															<select class="form-control selectpicker" onchange="get_product_segment(<?php echo $i; ?>,this.value,this)" data-live-search="true" id="product_id<?php echo $i; ?>" name="proenqdata[<?php echo $i;?>][product_id]">
																...
																if (isset($product_data) && count($product_data) > 0) {
																	foreach ($product_data as $product_key => $product_val) {
																		...
																		?>
																		<option value="<?php echo $product_val['id']; ?>" <?php echo $selected; ?>><?php echo $product_val['name'].$product_code; ?></option>
																		<?php
																	}
																}
																?>
															...
															<select class="form-control selectpicker" onchange="get_product_segment(0,this.value,this)" data-live-search="true" id="product_id0" name="proenqdata[0][product_id]">
																...
																if (isset($product_data) && count($product_data) > 0) {
																	foreach ($product_data as $product_key => $product_value) {
																		...
																		?>
																		<option value="<?php echo $product_value['id'] ?>"><?php echo $product_value['name'].$product_code; ?></option>
																		<?php
																	}
																}
																?>
