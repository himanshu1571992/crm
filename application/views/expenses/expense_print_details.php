...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>		
	...
	<body>
		...
		<table cellpadding="0" cellspacing="0">
			<tr>
				<td rowspan="3" style="padding:5px; border: 1px solid #111; border-right:none; width:20%;"><img src="<?php echo base_url('uploads/company/logo.png')?>" alt="Schach Engineers Pvt Ltd"></td>
		...
		<table cellpadding="0" cellspacing="0">
			...
			if($ttl_amount > 0 || $ttl_advance > 0 || $ttl_paid > 0){				?>
				<tfoot>
					<tr>
						<td colspan="13" style="background:#f0f0f0; text-align:center; padding:8px; border: 1px solid #111;"><b>Total</b></td>
				...
				echo '<tfoot>
					<tr>
						<td colspan="15" style="background:#f0f0f0; text-align:center; padding:8px; border: 1px solid #111;"><b>No Record Found!</b></td>
					</tr>
				</tfoot>';
			}
			?>
