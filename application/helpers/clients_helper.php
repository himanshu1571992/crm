 ...
 */
 ...
 function get_customer_profile_tab($customer_id) {
    $customer_tabs = [
        [
            'name' => 'profile',
            'url' => admin_url('vendors/vendor/' . $customer_id . '?group=profile'),
        ...
        [
            'name' => 'contacts',
            'url' => admin_url('vendors/vendor/' . $customer_id . '?group=contacts'),
            'icon' => 'fa fa-users',
		 ...
		 [
            'name' => 'banklist',
            'url' => admin_url('vendors/vendor/' . $customer_id . '?group=banklist'),
            'icon' => 'fa fa-file-text menu-icon',
            'lang' => _l('bank_details'),
            'visible' => true,
            'order' => 3,
        ],
		[
            'name' => 'documentlist',
            'url' => admin_url('vendors/vendor/' . $customer_id . '?group=documentlist'),
        ...
        [
            'name' => 'notes',
            'url' => admin_url('vendors/vendor/' . $customer_id . '?group=notes'),
...
function get_customer_profile_tabs($customer_id) {
    $customer_tabs = [
		...
		[
            'name' => 'Created Chalan',
            'url' => admin_url('clients/client/' . $customer_id . '?group=chalan'),
        ...
        [
            ...
            'lang' => 'Purchase Orders Files',
            'visible' => true,
            'order' => 17,
        ],*/
        [
            'name' => 'debit_note',
            'url' => admin_url('clients/client/' . $customer_id . '?group=debit_note'),
            'icon' => 'fa fa-file-text-o',
            'lang' => 'Debit Note',
            'visible' => true,
            'order' => 18,
        ...
        [
            'name' => 'payment_debit_note',
            'url' => admin_url('clients/client/' . $customer_id . '?group=payment_debit_note'),
            'icon' => 'fa fa-file-text',
            'lang' => 'Payment Debit Note',
            'visible' => true,
            'order' => 19,
        ],
        /*[
        ...
        [
            ...
            'url' => admin_url('clients/client/' . $customer_id . '?group=client_document'),
            'icon' => 'fa fa-folder',
            'lang' => 'Client Document',
            'visible' => true,
            'order' => 21,
        ],
        ...
        [
            'name' => 'client_ledger',
            'url' => base_url('admin/invoices/ledger/' . $customer_id),
            'icon' => 'fa fa-file-text-o',
            'lang' => 'Client Ledger',
            'visible' => true,
            'order' => 22,
        ...
        [
            'name' => 'ledger_reco',
            'url' => admin_url('clients/client/' . $customer_id. '?group=client_ledger_reco'),
            // 'url' => admin_url('clientBranch/client_ledger_reco/' . $customer_id),
            'icon' => 'fa fa-file-text-o',
            'lang' => 'Client Ledger Reco',
            'visible' => true,
            'order' => 23,
        ],
...
function get_company_name($userid, $prevent_empty_company = false) {
    ...
    //$select = ($prevent_empty_company == false ? get_sql_select_client_company() : 'client_branch_name');

    $client = $CI->db->select('client_branch_name')
            ->where('userid', $_userid)
            ->from('tblclientbranch')
            ->get()
            ->row();
    if ($client) {
        return $client->client_branch_name;
    }
...
function export_contact_data($contact_id) {
    ...
    if (in_array('customer_profile_data', $valAllowed) && $contact['is_primary'] == '1' && !$isIndividual) {
