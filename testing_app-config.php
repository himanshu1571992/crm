...
//define('APP_BASE_URL', 'http://13.232.113.182/crm/');
define('APP_BASE_URL', 'http://35.154.77.171/schach/');
...
//define('APP_DB_PASSWORD', 'Y#6y@ccQ');
define('APP_DB_PASSWORD', 'A88D?yJB');
/* The name of the database you want to connect to */
define('APP_DB_NAME', 'bookalls_schach');
